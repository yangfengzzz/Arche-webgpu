...
TEST(SoaMathArchive, vox_soa_math) {
    for (int e = 0; e < 2; ++e) {
        ...
        const vox::simd_math::SoaFloat2 of2 =
                vox::simd_math::SoaFloat2::Load(vox::simd_math::simd_float4::Load(0.f, 1.f, 2.f, 3.f),
                                                vox::simd_math::simd_float4::Load(4.f, 5.f, 6.f, 7.f));
        o << of2;
        const vox::simd_math::SoaFloat3 of3 =
        ...
        o << of3;
        const vox::simd_math::SoaFloat4 of4 =
                vox::simd_math::SoaFloat4::Load(vox::simd_math::simd_float4::Load(0.f, 1.f, 2.f, 3.f),
                                                vox::simd_math::simd_float4::Load(4.f, 5.f, 6.f, 7.f),
                                                vox::simd_math::simd_float4::Load(8.f, 9.f, 10.f, 11.f),
                                                vox::simd_math::simd_float4::Load(12.f, 13.f, 14.f, 15.f));
        o << of4;
        const vox::simd_math::SoaQuaternion oquat =
                vox::simd_math::SoaQuaternion::Load(vox::simd_math::simd_float4::Load(0.f, 1.f, 2.f, 3.f),
                                                    vox::simd_math::simd_float4::Load(4.f, 5.f, 6.f, 7.f),
                                                    vox::simd_math::simd_float4::Load(8.f, 9.f, 10.f, 11.f),
                                                    vox::simd_math::simd_float4::Load(12.f, 13.f, 14.f, 15.f));
        o << oquat;
        const vox::simd_math::SoaTransform otrans = {of3, oquat, of3};
        o << otrans;
        const vox::simd_math::SoaFloat4x4 of44 = {{{vox::simd_math::simd_float4::Load(0.f, 1.f, 0.f, 0.f),
        ...
        vox::simd_math::SoaFloat4x4 if44;
        i >> if44;
