...
TEST(SoaQuaternionArithmetic, vox_soa_math) {
    ...
    const SoaQuaternion b =
            SoaQuaternion::Load(vox::simd_math::simd_float4::Load(0.f, .70710677f, 0.f, -.382683432f),
                                vox::simd_math::simd_float4::Load(0.f, 0.f, .70710677f, 0.f),
                                vox::simd_math::simd_float4::Load(0.f, 0.f, 0.f, 0.f),
                                vox::simd_math::simd_float4::Load(1.f, .70710677f, .70710677f, .9238795f));
    const SoaQuaternion denorm = SoaQuaternion::Load(vox::simd_math::simd_float4::Load(.5f, 0.f, 2.f, 3.f),
                                                     vox::simd_math::simd_float4::Load(4.f, 0.f, 6.f, 7.f),
                                                     vox::simd_math::simd_float4::Load(8.f, 0.f, 10.f, 11.f),
                                                     vox::simd_math::simd_float4::Load(12.f, 1.f, 14.f, 15.f));

    EXPECT_TRUE(vox::simd_math::AreAllTrue(IsNormalized(a)));
    EXPECT_TRUE(vox::simd_math::AreAllTrue(IsNormalized(b)));
    EXPECT_SIMDINT_EQ(vox::simd_math::IsNormalized(denorm), 0, 0xffffffff, 0, 0);
    ...
    EXPECT_TRUE(vox::simd_math::AreAllTrue(IsNormalized(conjugate)));
    ...
    const SoaQuaternion muls = a * vox::simd_math::simd_float4::Load1(2.f);
    ...
    EXPECT_TRUE(vox::simd_math::AreAllTrue(IsNormalized(mul0)));
    ...
    EXPECT_TRUE(vox::simd_math::AreAllTrue(IsNormalized(mul1)));

    const vox::simd_math::SimdFloat4 dot = Dot(a, b);
    ...
    EXPECT_SOAQUATERNION_EQ_EST(normalize_est, .033389f, 0.f, .1091089f, .1492555f, .267112f, 0.f, .3273268f, .348263f,
                                .53422445f, 0.f, .545544f, .547270f, .80133667f, 1.f, .763762f, .74627789f);
    EXPECT_TRUE(vox::simd_math::AreAllTrue(IsNormalizedEst(normalize_est)));

    const SoaQuaternion lerp_0 = Lerp(a, b, vox::simd_math::simd_float4::zero());
    EXPECT_SOAQUATERNION_EQ(lerp_0, .70710677f, 0.f, 0.f, .382683432f, 0.f, 0.f, .70710677f, 0.f, 0.f, 0.f, 0.f, 0.f,
                            .70710677f, 1.f, .70710677f, .9238795f);

    const SoaQuaternion lerp_1 = Lerp(a, b, vox::simd_math::simd_float4::one());
    ...
    const SoaQuaternion lerp_0_2 = Lerp(a, b, vox::simd_math::simd_float4::Load1(.2f));
    ...
    const SoaQuaternion lerp_m = Lerp(a, b, vox::simd_math::simd_float4::Load(0.f, 1.f, 1.f, .2f));
    ...
    const SoaQuaternion nlerp_0 = NLerp(a, b, vox::simd_math::simd_float4::zero());
    EXPECT_SOAQUATERNION_EQ(nlerp_0, .70710677f, 0.f, 0.f, .382683432f, 0.f, 0.f, .70710677f, 0.f, 0.f, 0.f, 0.f, 0.f,
                            .70710677f, 1.f, .70710677f, .9238795f);
    EXPECT_TRUE(vox::simd_math::AreAllTrue(IsNormalized(nlerp_0)));

    const SoaQuaternion nlerp_1 = NLerp(a, b, vox::simd_math::simd_float4::one());
    EXPECT_SOAQUATERNION_EQ(nlerp_1, 0.f, .70710677f, 0.f, -.382683432f, 0.f, 0.f, .70710677f, 0.f, 0.f, 0.f, 0.f, 0.f,
                            1.f, .70710677f, .70710677f, .9238795f);
    EXPECT_TRUE(vox::simd_math::AreAllTrue(IsNormalized(nlerp_1)));

    const SoaQuaternion nlerp_0_2 = NLerp(a, b, vox::simd_math::simd_float4::Load1(.2f));
    EXPECT_TRUE(vox::simd_math::AreAllTrue(IsNormalized(nlerp_0_2)));
    ...
    const SoaQuaternion nlerp_m = NLerp(a, b, vox::simd_math::simd_float4::Load(0.f, 1.f, 1.f, .2f));
    ...
    EXPECT_TRUE(vox::simd_math::AreAllTrue(IsNormalized(nlerp_m)));

    const SoaQuaternion nlerp_est_m = NLerpEst(a, b, vox::simd_math::simd_float4::Load(0.f, 1.f, 1.f, .2f));
    ...
    EXPECT_TRUE(vox::simd_math::AreAllTrue(IsNormalizedEst(nlerp_est_m)));
}
