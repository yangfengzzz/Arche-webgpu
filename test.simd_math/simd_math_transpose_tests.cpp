...
TEST(TransposeFloat, vox_simd_math) {
    ...
    SimdFloat4 t4x1[1];
    vox::math::Transpose4x1(src, t4x1);
    EXPECT_SIMDFLOAT_EQ(t4x1[0], 0.f, 4.f, 8.f, 12.f);

    SimdFloat4 t1x4[4];
    vox::math::Transpose1x4(src, t1x4);
    ...
    SimdFloat4 t4x3[3];
    vox::math::Transpose4x3(src, t4x3);
    ...
    SimdFloat4 t3x4[4];
    vox::math::Transpose3x4(src, t3x4);
    ...
    SimdFloat4 t4x4[4];
    vox::math::Transpose4x4(src, t4x4);
    ...
    const SimdFloat4 src2[16] = {
            vox::math::simd_float4::Load(0.f, 16.f, 32.f, 48.f),  vox::math::simd_float4::Load(1.f, 17.f, 33.f, 49.f),
            vox::math::simd_float4::Load(2.f, 18.f, 34.f, 50.f),  vox::math::simd_float4::Load(3.f, 19.f, 35.f, 51.f),
            vox::math::simd_float4::Load(4.f, 20.f, 36.f, 52.f),  vox::math::simd_float4::Load(5.f, 21.f, 37.f, 53.f),
            vox::math::simd_float4::Load(6.f, 22.f, 38.f, 54.f),  vox::math::simd_float4::Load(7.f, 23.f, 39.f, 55.f),
            vox::math::simd_float4::Load(8.f, 24.f, 40.f, 56.f),  vox::math::simd_float4::Load(9.f, 25.f, 41.f, 57.f),
            vox::math::simd_float4::Load(10.f, 26.f, 42.f, 58.f), vox::math::simd_float4::Load(11.f, 27.f, 43.f, 59.f),
            vox::math::simd_float4::Load(12.f, 28.f, 44.f, 60.f), vox::math::simd_float4::Load(13.f, 29.f, 45.f, 61.f),
            vox::math::simd_float4::Load(14.f, 30.f, 46.f, 62.f), vox::math::simd_float4::Load(15.f, 31.f, 47.f, 63.f)};
    SimdFloat4 t16x16[16];
    vox::math::Transpose16x16(src2, t16x16);
