...
public:
    ...
    //! Computes this + (v, v).
    [[nodiscard]] Size2 add(size_t v) const;

    //! Computes this + (v.x, v.y).
    [[nodiscard]] Size2 add(const Size2 &v) const;

    //! Computes this - (v, v).
    [[nodiscard]] Size2 sub(size_t v) const;

    //! Computes this - (v.x, v.y).
    [[nodiscard]] Size2 sub(const Size2 &v) const;

    //! Computes this * (v, v).
    [[nodiscard]] Size2 mul(size_t v) const;

    //! Computes this * (v.x, v.y).
    [[nodiscard]] Size2 mul(const Size2 &v) const;

    //! Computes this / (v, v).
    [[nodiscard]] Size2 div(size_t v) const;

    //! Computes this / (v.x, v.y).
    [[nodiscard]] Size2 div(const Size2 &v) const;

    // MARK: - Binary operations: new instance = v (+) this

    //! Computes (v, v) - this.
    [[nodiscard]] Size2 rsub(size_t v) const;

    //! Computes (v.x, v.y) - this.
    [[nodiscard]] Size2 rsub(const Size2 &v) const;

    //! Computes (v, v) / this.
    [[nodiscard]] Size2 rdiv(size_t v) const;

    //! Computes (v.x, v.y) / this.
    [[nodiscard]] Size2 rdiv(const Size2 &v) const;
    ...
    [[nodiscard]] const size_t &at(size_t i) const;
    ...
    [[nodiscard]] size_t absmin() const;

    //! Returns the absolute maximum value among x and y.
    [[nodiscard]] size_t absmax() const;
    ...
    [[nodiscard]] bool isEqual(const Size2 &other) const;
