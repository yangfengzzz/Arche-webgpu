...
#ifndef INCLUDE_VOX_DETAIL_OCTREE_INL_H_
#define INCLUDE_VOX_DETAIL_OCTREE_INL_H_
...
Octree<T>::nearest(const Point3D &pt, const NearestNeighborDistanceFunc3<T> &distanceFunc) const {
...
template<typename T>
void Octree<T>::forEachIntersectingItem(const BoundingBox3D &box, const BoxIntersectionTestFunc3<T> &testFunc,
                                        const IntersectionVisitorFunc3<T> &visitorFunc) const {
    forEachIntersectingItem(box, testFunc, visitorFunc, 0, _bbox);
}

template<typename T>
void Octree<T>::forEachIntersectingItem(const Ray3D &ray, const RayIntersectionTestFunc3<T> &testFunc,
                                        const IntersectionVisitorFunc3<T> &visitorFunc) const {
...
Octree<T>::closestIntersection(const Ray3D &ray, const GetRayIntersectionFunc3<T> &testFunc) const {
...
template<typename T>
ClosestIntersectionQueryResult3<T> Octree<T>::closestIntersection(const Ray3D &ray, const GetRayIntersectionFunc3<T> &testFunc,
...
#endif  // INCLUDE_VOX_DETAIL_OCTREE_INL_H_
