...
public:
    ...
    constexpr explicit Vector(T x) : x(x), y(x) {}
    ...
    static VOX_INLINE Vector x_axis() { return Vector(1.f, 0.f); }

    // Returns a unitary vector y.
    static VOX_INLINE Vector y_axis() { return Vector(0.f, 1.f); }
};
...
#include "vox.math/vector2-inl.h"
