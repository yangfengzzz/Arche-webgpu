...
void WGSLPbrFragDefine::operator()(WGSLEncoder& encoder, const ShaderMacroCollection& macros, size_t counterIndex) {
    ...
    if (macros.contains(HAS_BASE_COLORMAP)) {
        encoder.addSampledTextureBinding("u_baseColorTexture", TextureType::Texture2Df32, "u_baseColorSampler",
                                         SamplerType::Sampler);
    }
    ...
    if (macros.contains(HAS_OCCLUSIONMAP)) {
        encoder.addSampledTextureBinding("u_occlusionTexture", TextureType::Texture2Df32, "u_occlusionSampler",
                                         SamplerType::Sampler);
    }
