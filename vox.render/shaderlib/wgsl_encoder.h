...
public:
    ...
    void addSampledTextureBinding(const std::string& texName,
                                  TextureType texType,
...
public:
    void addStorageBufferBinding(const std::string& bufferName, UniformType type, bool isRead, uint32_t group = 0);

    void addStorageBufferBinding(const std::string& bufferName,
    ...
    void addStorageTextureBinding(const std::string& texName,
...
public:
    ...
    void addInoutType(const std::string& structName,
                      uint32_t location,
...
public:
    ...
    void addEntry(const std::array<uint32_t, 3>& workgroupSize,
                  std::function<void(std::string&)> code,
                  const std::initializer_list<std::pair<std::string, BuiltInType>>& builtIn = {});
