...
public:
    ...
    static void createTextureArray(const std::vector<wgpu::Texture>::iterator &texturesBegin,
                                   const std::vector<wgpu::Texture>::iterator &texturesEnd,
    ...
    static void createCubeTextureArray(const std::vector<wgpu::Texture>::iterator &texturesBegin,
                                       const std::vector<wgpu::Texture>::iterator &texturesEnd,
                                       SampledTexturePtr textureArray,
                                       wgpu::CommandEncoder& commandEncoder);
    ...
    static void createAtlas(const std::array<wgpu::Texture, 4> &textures,
                            wgpu::Texture& atlas,
                            wgpu::CommandEncoder& commandEncoder);
    ...
    static void createCubeAtlas(const std::array<wgpu::Texture, 6> &textures,
                                wgpu::Texture& atlas,
                                wgpu::CommandEncoder& commandEncoder);
};
