...
TEST(Parallel, For2D) {
    ...
    parallelFor(kZeroSize, a.width(), kZeroSize, a.height(), [&](size_t i, size_t j) {
...
TEST(Parallel, RangeFor2D) {
    ...
    parallelRangeFor(kZeroSize, a.width(), kZeroSize, a.height(),
...
TEST(Parallel, For3D) {
    ...
    parallelFor(kZeroSize, a.width(), kZeroSize, a.height(), kZeroSize, a.depth(), [&](size_t i, size_t j, size_t k) {
...
TEST(Parallel, RangeFor3D) {
    ...
    parallelRangeFor(kZeroSize, a.width(), kZeroSize, a.height(), kZeroSize, a.depth(),
...
TEST(Parallel, Sort) {
    ...
    parallelSort(idx.begin(), idx.end(), [&](size_t i1, size_t i2) { return c[i1] < c[i2]; });
