...
TEST(ParticleSystemData2, AddParticles) {
    ...
    particleSystem.addParticles(Array1<Point2D>({Point2D(1.0, 2.0), Point2D(4.0, 5.0)}).accessor(),
    ...
    EXPECT_EQ(Point2D(1.0, 2.0), p[12]);
    EXPECT_EQ(Point2D(4.0, 5.0), p[13]);
...
TEST(ParticleSystemData2, BuildNeighborSearcher) {
    ParticleSystemData2 particleSystem;
    Array1<Point2D> positions = {{0.5, 0.7}, {0.1, 0.5}, {0.3, 0.1}, {0.2, 0.6}, {0.9, 0.7}, {0.2, 0.5}, {0.5, 0.8},
                                 {0.2, 0.3}, {0.9, 0.1}, {0.6, 0.8}, {0.1, 0.7}, {0.4, 0.5}, {0.5, 0.9}, {0.7, 0.9},
                                 {0.2, 0.8}, {0.5, 0.5}, {0.4, 0.1}, {0.2, 0.4}, {0.1, 0.6}, {0.9, 0.8}};
    ...
    const Point2D searchOrigin = {0.1, 0.2};
    std::vector<size_t> found;
    neighborSearcher->forEachNearbyPoint(searchOrigin, radius, [&](size_t i, const Point2D&) { found.push_back(i); });
...
TEST(ParticleSystemData2, BuildNeighborLists) {
    ParticleSystemData2 particleSystem;
    Array1<Point2D> positions = {{0.3, 0.5}, {0.6, 0.8}, {0.1, 0.8}, {0.7, 0.9}, {0.3, 0.2}, {0.8, 0.3}, {0.8, 0.5},
                                 {0.4, 0.9}, {0.8, 0.6}, {0.2, 0.9}, {0.1, 0.2}, {0.6, 0.9}, {0.2, 0.2}, {0.5, 0.6},
                                 {0.8, 0.4}, {0.4, 0.2}, {0.2, 0.3}, {0.8, 0.6}, {0.2, 0.8}, {1.0, 0.5}};
    particleSystem.addParticles(positions.constAccessor());
