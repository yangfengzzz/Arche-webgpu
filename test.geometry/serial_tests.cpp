...
TEST(Serial, For2D) {
    ...
    serialFor(kZeroSize, a.width(), kZeroSize, a.height(), [&](size_t i, size_t j) {
...
TEST(Serial, For3D) {
    ...
    serialFor(kZeroSize, a.width(), kZeroSize, a.height(), kZeroSize, a.depth(), [&](size_t i, size_t j, size_t k) {
...
TEST(Serial, Sort) {
    ...
    serialSort(idx.begin(), idx.end(), [&](size_t a, size_t b) { return c[a] < c[b]; });
