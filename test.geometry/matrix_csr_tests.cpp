...
TEST(MatrixCsr, Constructors) {
    ...
    const MatrixCsrD matInitLst = {{1.0, 0.0, 0.0, -3.0}, {0.0, 3.0, -5.0, 1.0}, {-4.0, 0.0, 1.0, 5.0}};
    ...
    const MatrixMxND matDense = {{1.0, 0.01, 0.0, -3.0}, {0.01, 3.0, -5.0, 1.0}, {-4.0, 0.01, 1.0, 5.0}};
...
TEST(MatrixCsr, GetterOperators) {
    const MatrixMxND matDense = {{1.0, 0.0, 0.0, -3.0}, {0.0, 3.0, -5.0, 1.0}, {-4.0, 0.0, 1.0, 5.0}};
    const MatrixCsrD matSparse(matDense, 0.02);
