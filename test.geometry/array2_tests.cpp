...
TEST(Array2, Constructors) {
    ...
    {
        Array2<float> arr({{1.f, 2.f, 3.f, 4.f}, {5.f, 6.f, 7.f, 8.f}, {9.f, 10.f, 11.f, 12.f}});
...
TEST(Array2, AtMethod) {
    {
        float values[12] = {0.f, 1.f, 2.f, 3.f, 4.f, 5.f, 6.f, 7.f, 8.f, 9.f, 10.f, 11.f};
...
TEST(Array2, Iterators) {
    Array2<float> arr1({{1.f, 2.f, 3.f, 4.f}, {5.f, 6.f, 7.f, 8.f}, {9.f, 10.f, 11.f, 12.f}});
