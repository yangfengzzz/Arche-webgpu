...
void CellCenteredVectorGrid3::set(const CellCenteredVectorGrid3 &other) { setCollocatedVectorGrid(other); }
...
void CellCenteredVectorGrid3::fill(const std::function<Vector3D(const Point3D &)> &func, ExecutionPolicy policy) {
    Size3 size = dataSize();
    auto acc = dataAccessor();
...
CellCenteredVectorGrid3::Builder &CellCenteredVectorGrid3::Builder::withResolution(size_t resolutionX,
                                                                                   size_t resolutionY,
                                                                                   size_t resolutionZ) {
...
CellCenteredVectorGrid3::Builder &CellCenteredVectorGrid3::Builder::withGridSpacing(double gridSpacingX,
                                                                                    double gridSpacingY,
                                                                                    double gridSpacingZ) {
...
CellCenteredVectorGrid3::Builder &CellCenteredVectorGrid3::Builder::withOrigin(const Point3D &gridOrigin) {
    _gridOrigin = gridOrigin;
    return *this;
}

CellCenteredVectorGrid3::Builder &CellCenteredVectorGrid3::Builder::withOrigin(double gridOriginX,
                                                                               double gridOriginY,
                                                                               double gridOriginZ) {
...
CellCenteredVectorGrid3::Builder &CellCenteredVectorGrid3::Builder::withInitialValue(double initialValX,
                                                                                     double initialValY,
                                                                                     double initialValZ) {
...
CellCenteredVectorGrid3 CellCenteredVectorGrid3::Builder::build() const {
    return CellCenteredVectorGrid3(_resolution, _gridSpacing, _gridOrigin, _initialVal);
}

VectorGrid3Ptr CellCenteredVectorGrid3::Builder::build(const Size3 &resolution,
                                                       const Vector3D &gridSpacing,
