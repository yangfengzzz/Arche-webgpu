...
#include "vox.geometry/grid_emitter_set2.h"

#include <vector>

using namespace vox;

GridEmitterSet2::GridEmitterSet2() = default;
...
void GridEmitterSet2::addEmitter(const GridEmitter2Ptr& emitter) { _emitters.push_back(emitter); }
...
GridEmitterSet2::Builder GridEmitterSet2::builder() { return {}; }
...
GridEmitterSet2 GridEmitterSet2::Builder::build() const { return GridEmitterSet2(_emitters); }

GridEmitterSet2Ptr GridEmitterSet2::Builder::makeShared() const {
    return {new GridEmitterSet2(_emitters), [](GridEmitterSet2* obj) { delete obj; }};
}
