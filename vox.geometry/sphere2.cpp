...
Sphere2::Sphere2(const Transform2D& transform_, bool isNormalFlipped_) : Surface2(transform_, isNormalFlipped_) {}

Sphere2::Sphere2(const Point2D& center_, double radius_, const Transform2D& transform_, bool isNormalFlipped_)
    : Surface2(transform_, isNormalFlipped_), center(center_), radius(radius_) {}

Sphere2::Sphere2(const Sphere2& other) = default;
...
Sphere2 Sphere2::Builder::build() const { return Sphere2(_center, _radius, _transform, _isNormalFlipped); }
