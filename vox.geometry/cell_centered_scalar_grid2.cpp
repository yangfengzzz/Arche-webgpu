...
CellCenteredScalarGrid2::CellCenteredScalarGrid2() = default;

CellCenteredScalarGrid2::CellCenteredScalarGrid2(size_t resolutionX,
                                                 size_t resolutionY,
                                                 double gridSpacingX,
                                                 double gridSpacingY,
                                                 double originX,
...
CellCenteredScalarGrid2::CellCenteredScalarGrid2(const CellCenteredScalarGrid2 &other) { set(other); }
...
Point2D CellCenteredScalarGrid2::dataOrigin() const { return origin() + 0.5 * gridSpacing(); }
...
void CellCenteredScalarGrid2::swap(Grid2 *other) {
    auto *sameType = dynamic_cast<CellCenteredScalarGrid2 *>(other);
    if (sameType != nullptr) {
        swapScalarGrid(sameType);
    }
}

void CellCenteredScalarGrid2::set(const CellCenteredScalarGrid2 &other) { setScalarGrid(other); }
...
CellCenteredScalarGrid2::Builder CellCenteredScalarGrid2::builder() { return {}; }
...
CellCenteredScalarGrid2::Builder &CellCenteredScalarGrid2::Builder::withResolution(size_t resolutionX,
                                                                                   size_t resolutionY) {
...
CellCenteredScalarGrid2::Builder &CellCenteredScalarGrid2::Builder::withGridSpacing(double gridSpacingX,
                                                                                    double gridSpacingY) {
...
CellCenteredScalarGrid2::Builder &CellCenteredScalarGrid2::Builder::withOrigin(const Point2D &gridOrigin) {
...
CellCenteredScalarGrid2 CellCenteredScalarGrid2::Builder::build() const {
    return CellCenteredScalarGrid2(_resolution, _gridSpacing, _gridOrigin, _initialVal);
}

ScalarGrid2Ptr CellCenteredScalarGrid2::Builder::build(const Size2 &resolution,
                                                       const Vector2D &gridSpacing,
...
CellCenteredScalarGrid2Ptr CellCenteredScalarGrid2::Builder::makeShared() const {
    return {new CellCenteredScalarGrid2(_resolution, _gridSpacing, _gridOrigin, _initialVal),
            [](CellCenteredScalarGrid2 *obj) { delete obj; }};
}
