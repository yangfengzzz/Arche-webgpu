...
VertexCenteredVectorGrid3::VertexCenteredVectorGrid3(const Size3 &resolution,
...
void VertexCenteredVectorGrid3::fill(const Vector3D &value, ExecutionPolicy policy) {
    ...
    parallelFor(
            ...
            [value, &acc](size_t i, size_t j, size_t k) { acc(i, j, k) = value; }, policy);
}

void VertexCenteredVectorGrid3::fill(const std::function<Vector3D(const Point3D &)> &func, ExecutionPolicy policy) {
    Size3 size = dataSize();
    auto acc = dataAccessor();
    DataPositionFunc pos = dataPosition();
    parallelFor(
            kZeroSize, size.x, kZeroSize, size.y, kZeroSize, size.z,
            [&func, &acc, &pos](size_t i, size_t j, size_t k) { acc(i, j, k) = func(pos(i, j, k)); }, policy);
}
...
VertexCenteredVectorGrid3::Builder &VertexCenteredVectorGrid3::Builder::withResolution(size_t resolutionX,
                                                                                       size_t resolutionY,
                                                                                       size_t resolutionZ) {
...
VertexCenteredVectorGrid3::Builder &VertexCenteredVectorGrid3::Builder::withGridSpacing(double gridSpacingX,
                                                                                        double gridSpacingY,
                                                                                        double gridSpacingZ) {
...
VertexCenteredVectorGrid3::Builder &VertexCenteredVectorGrid3::Builder::withOrigin(const Point3D &gridOrigin) {
    _gridOrigin = gridOrigin;
    return *this;
}

VertexCenteredVectorGrid3::Builder &VertexCenteredVectorGrid3::Builder::withOrigin(double gridOriginX,
                                                                                   double gridOriginY,
                                                                                   double gridOriginZ) {
...
VertexCenteredVectorGrid3::Builder &VertexCenteredVectorGrid3::Builder::withInitialValue(const Vector3D &initialVal) {
    _initialVal = initialVal;
    return *this;
}

VertexCenteredVectorGrid3::Builder &VertexCenteredVectorGrid3::Builder::withInitialValue(double initialValX,
                                                                                         double initialValY,
                                                                                         double initialValZ) {
...
VertexCenteredVectorGrid3 VertexCenteredVectorGrid3::Builder::build() const {
    return VertexCenteredVectorGrid3(_resolution, _gridSpacing, _gridOrigin, _initialVal);
}
