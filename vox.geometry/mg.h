...
template <typename BlasType>
using MgRelaxFunc = std::function<void(const typename BlasType::MatrixType &A,
...
using MgRestrictFunc =
        std::function<void(const typename BlasType::VectorType &finer, typename BlasType::VectorType *coarser)>;

//! Multigrid correction function type.
template <typename BlasType>
using MgCorrectFunc =
        std::function<void(const typename BlasType::VectorType &coarser, typename BlasType::VectorType *finer)>;
