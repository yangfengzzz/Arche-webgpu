...
CellCenteredScalarGrid3::CellCenteredScalarGrid3(const CellCenteredScalarGrid3 &other) { set(other); }
...
void CellCenteredScalarGrid3::set(const CellCenteredScalarGrid3 &other) { setScalarGrid(other); }

CellCenteredScalarGrid3 &CellCenteredScalarGrid3::operator=(const CellCenteredScalarGrid3 &other) {
    set(other);
    return *this;
}
...
CellCenteredScalarGrid3::Builder &CellCenteredScalarGrid3::Builder::withResolution(size_t resolutionX,
                                                                                   size_t resolutionY,
                                                                                   size_t resolutionZ) {
...
CellCenteredScalarGrid3::Builder &CellCenteredScalarGrid3::Builder::withGridSpacing(const Vector3D &gridSpacing) {
    _gridSpacing = gridSpacing;
    return *this;
}

CellCenteredScalarGrid3::Builder &CellCenteredScalarGrid3::Builder::withGridSpacing(double gridSpacingX,
                                                                                    double gridSpacingY,
                                                                                    double gridSpacingZ) {
...
CellCenteredScalarGrid3::Builder &CellCenteredScalarGrid3::Builder::withOrigin(const Point3D &gridOrigin) {
    _gridOrigin = gridOrigin;
    return *this;
}

CellCenteredScalarGrid3::Builder &CellCenteredScalarGrid3::Builder::withOrigin(double gridOriginX,
                                                                               double gridOriginY,
                                                                               double gridOriginZ) {
...
CellCenteredScalarGrid3::Builder &CellCenteredScalarGrid3::Builder::withInitialValue(double initialVal) {
    _initialVal = initialVal;
    return *this;
}

CellCenteredScalarGrid3 CellCenteredScalarGrid3::Builder::build() const {
    return CellCenteredScalarGrid3(_resolution, _gridSpacing, _gridOrigin, _initialVal);
}

ScalarGrid3Ptr CellCenteredScalarGrid3::Builder::build(const Size3 &resolution,
                                                       const Vector3D &gridSpacing,
                                                       const Point3D &gridOrigin,
                                                       double initialVal) const {
    return std::shared_ptr<CellCenteredScalarGrid3>(
            new CellCenteredScalarGrid3(resolution, gridSpacing, gridOrigin, initialVal),
