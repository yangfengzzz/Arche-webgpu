...
public:
    ...
    typedef Array1<Point3D> PointArray;
...
private:
    ...
    mutable Array1<Point3D> _wnAreaWeightedAvgPositions;
    ...
    double fastWindingNumber(const Point3D &queryPoint, size_t rootNodeIndex, double accuracy) const;
};
