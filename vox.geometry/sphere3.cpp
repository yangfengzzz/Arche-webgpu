...
Sphere3::Sphere3(const Transform3D& transform_, bool isNormalFlipped_) : Surface3(transform_, isNormalFlipped_) {}

Sphere3::Sphere3(const Point3D& center_, double radius_, const Transform3D& transform_, bool isNormalFlipped_)
    : Surface3(transform_, isNormalFlipped_), center(center_), radius(radius_) {}

Sphere3::Sphere3(const Sphere3& other) = default;
...
Sphere3 Sphere3::Builder::build() const { return Sphere3(_center, _radius, _transform, _isNormalFlipped); }
