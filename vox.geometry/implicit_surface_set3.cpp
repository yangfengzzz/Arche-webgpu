...
ImplicitSurfaceSet3::ImplicitSurfaceSet3() = default;
...
ImplicitSurfaceSet3::ImplicitSurfaceSet3(const ImplicitSurfaceSet3 &other)
    : ImplicitSurface3(other), _surfaces(other._surfaces), _unboundedSurfaces(other._unboundedSurfaces) {}
...
size_t ImplicitSurfaceSet3::numberOfSurfaces() const { return _surfaces.size(); }

const ImplicitSurface3Ptr &ImplicitSurfaceSet3::surfaceAt(size_t i) const { return _surfaces[i]; }
...
ImplicitSurfaceSet3::Builder ImplicitSurfaceSet3::builder() { return {}; }
...
ImplicitSurfaceSet3Ptr ImplicitSurfaceSet3::Builder::makeShared() const {
    return {new ImplicitSurfaceSet3(_surfaces, _transform, _isNormalFlipped),
