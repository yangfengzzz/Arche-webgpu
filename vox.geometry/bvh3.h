...
#include "vox.geometry/intersection_query_engine3.h"
#include "vox.geometry/nearest_neighbor_query_engine3.h"
...
public:
    ...
    //! function.
    NearestNeighborQueryResult3<T> nearest(const Point3D &pt,
    ...
    [[nodiscard]] const BoundingBox3D &nodeBound(size_t i) const;
...
#include "vox.geometry/bvh3-inl.h"