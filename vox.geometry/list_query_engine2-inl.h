...
template <typename T>
bool ListQueryEngine2<T>::intersects(const BoundingBox2D& box, const BoxIntersectionTestFunc2<T>& testFunc) const {
...
template <typename T>
void ListQueryEngine2<T>::forEachIntersectingItem(const BoundingBox2D& box,
...
template <typename T>
void ListQueryEngine2<T>::forEachIntersectingItem(const Ray2D& ray,
...
template <typename T>
NearestNeighborQueryResult2<T> ListQueryEngine2<T>::nearest(const Point2D& pt,
