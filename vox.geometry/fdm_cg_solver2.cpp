...
bool FdmCgSolver2::solve(FdmLinearSystem2 *system) {
    ...
    cg<FdmBlas2>(matrix, rhs, _maxNumberOfIterations, _tolerance, &solution, &_r, &_d, &_q, &_s,
...
bool FdmCgSolver2::solveCompressed(FdmCompressedLinearSystem2 *system) {
    ...
    cg<FdmCompressedBlas2>(matrix, rhs, _maxNumberOfIterations, _tolerance, &solution, &_rComp, &_dComp, &_qComp,
