...
CellCenteredVectorGrid2::CellCenteredVectorGrid2(const CellCenteredVectorGrid2 &other) { set(other); }
...
void CellCenteredVectorGrid2::set(const CellCenteredVectorGrid2 &other) { setCollocatedVectorGrid(other); }
...
void CellCenteredVectorGrid2::fill(const std::function<Vector2D(const Point2D &)> &func, ExecutionPolicy policy) {
    Size2 size = dataSize();
    auto acc = dataAccessor();
...
CellCenteredVectorGrid2::Builder &CellCenteredVectorGrid2::Builder::withResolution(size_t resolutionX,
                                                                                   size_t resolutionY) {
...
CellCenteredVectorGrid2::Builder &CellCenteredVectorGrid2::Builder::withGridSpacing(double gridSpacingX,
                                                                                    double gridSpacingY) {
...
CellCenteredVectorGrid2::Builder &CellCenteredVectorGrid2::Builder::withOrigin(const Point2D &gridOrigin) {
...
CellCenteredVectorGrid2::Builder &CellCenteredVectorGrid2::Builder::withInitialValue(double initialValX,
                                                                                     double initialValY) {
...
CellCenteredVectorGrid2 CellCenteredVectorGrid2::Builder::build() const {
    return CellCenteredVectorGrid2(_resolution, _gridSpacing, _gridOrigin, _initialVal);
}

VectorGrid2Ptr CellCenteredVectorGrid2::Builder::build(const Size2 &resolution,
                                                       const Vector2D &gridSpacing,
