...
bool PhysicsGearConstraintApp::prepare(Platform &platform) {
...
void PhysicsGearConstraintApp::loadScene() {
    auto scene = _sceneManager->currentScene();
    ...
    JPH::BodyInterface &body_interface = PhysicsManager::GetSingleton().getBodyInterface();
    {
        ...
        Body *gear1 =
                body_interface.CreateBody(BodyCreationSettings(&gear1_settings, gear1_initial_p, gear1_initial_r,
                                                               EMotionType::Dynamic, PhysicsManager::Layers::MOVING));
        body_interface.AddBody(gear1->GetID(), EActivation::Activate);
        ...
        Body *gear2 =
                body_interface.CreateBody(BodyCreationSettings(&gear2_settings, gear2_initial_p, gear2_initial_r,
                                                               EMotionType::Dynamic, PhysicsManager::Layers::MOVING));
        body_interface.AddBody(gear2->GetID(), EActivation::Activate);
        ...
        PhysicsManager::GetSingleton().addConstraint(hinge1_constraint);
        ...
        PhysicsManager::GetSingleton().addConstraint(hinge2_constraint);
        ...
        auto *gear_constraint = static_cast<GearConstraint *>(gear.Create(*gear1, *gear2));
        gear_constraint->SetConstraints(hinge1_constraint, hinge2_constraint);
        PhysicsManager::GetSingleton().addConstraint(gear_constraint);
