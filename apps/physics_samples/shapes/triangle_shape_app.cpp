...
bool PhysicsTriangleShapeApp::prepare(Platform& platform) {
...
void PhysicsTriangleShapeApp::loadScene() {
    auto scene = _sceneManager->currentScene();
    ...
    {
        // Single triangle
        RefConst<TriangleShape> triangle_shape =
                new TriangleShape(Vec3(-10, -1, 0), Vec3(0, 1, 10), Vec3(10, -2, -10), 0.01f);
        Body& body1 = *body_interface.CreateBody(BodyCreationSettings(triangle_shape, Vec3::sZero(), Quat::sIdentity(),
                                                                      EMotionType::Static,
        ...
        Body& dynamic = *body_interface.CreateBody(BodyCreationSettings(
                box_shape, Vec3(0, 5, 0), Quat::sIdentity(), EMotionType::Dynamic, PhysicsManager::Layers::MOVING));
