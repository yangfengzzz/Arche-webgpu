...
bool PhysicsScaledStaticCompoundShapeApp::prepare(Platform &platform) {
...
void PhysicsScaledStaticCompoundShapeApp::loadScene() {
    auto scene = _sceneManager->currentScene();
    ...
    JPH::BodyInterface &body_interface = PhysicsManager::GetSingleton().getBodyInterface();
    {
        ...
        // Original shape
        Body &body1 =
                *body_interface.CreateBody(BodyCreationSettings(compound_shape, Vec3(-40, 10, 0), Quat::sIdentity(),
        ...
        Body &body4 = *body_interface.CreateBody(BodyCreationSettings(
                new ScaledShapeSettings(compound_shape, Vec3(-0.25f, 0.5f, -1.5f)), Vec3(20, 10, 0), Quat::sIdentity(),
                EMotionType::Dynamic, PhysicsManager::Layers::MOVING));
