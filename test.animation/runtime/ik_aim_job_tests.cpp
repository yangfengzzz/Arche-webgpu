...
TEST(Correction, IKAimJob) {
    ...
    for (size_t i = 0; i < VOX_ARRAY_SIZE(parents); ++i) {
        ...
        {  // -x
            job.target = TransformPoint(parent, -vox::simd_math::simd_float4::x_axis());
            EXPECT_TRUE(job.Run());
            const vox::QuaternionF y_Pi = vox::QuaternionF::make(vox::Vector3F::y_axis(), vox::simd_math::kPi);
        ...
        {  // 45 up y
            ...
            EXPECT_TRUE(job.Run());
            const vox::QuaternionF z_Pi_4 =
                    vox::QuaternionF::FromAxisAngle(vox::Vector3F::z_axis(), vox::simd_math::kPi_4);
...
TEST(Forward, IKAimJob) {
    ...
    {  // forward z
        ...
        EXPECT_TRUE(job.Run());
        const vox::QuaternionF y_Pi_2 = vox::QuaternionF::FromAxisAngle(vox::Vector3F::y_axis(), vox::simd_math::kPi_2);
        EXPECT_SIMDQUATERNION_EQ_TOL(quat, y_Pi_2.x, y_Pi_2.y, y_Pi_2.z, y_Pi_2.w, 2e-3f);
    }
}
...
TEST(Up, IKAimJob) {
    ...
    {  // up -y
        job.up = -vox::simd_math::simd_float4::y_axis();
        EXPECT_TRUE(job.Run());
        const vox::QuaternionF x_Pi = vox::QuaternionF::FromAxisAngle(vox::Vector3F::x_axis(), vox::simd_math::kPi);
    ...
    {  // up z
        ...
        EXPECT_TRUE(job.Run());
        const vox::QuaternionF x_mPi_2 =
                vox::QuaternionF::FromAxisAngle(vox::Vector3F::x_axis(), -vox::simd_math::kPi_2);
...
TEST(Pole, IKAimJob) {
    ...
    {  // Pole z
        ...
        EXPECT_TRUE(job.Run());
        const vox::QuaternionF x_Pi_2 = vox::QuaternionF::FromAxisAngle(vox::Vector3F::x_axis(), vox::simd_math::kPi_2);
...
TEST(Offset, IKAimJob) {
    ...
    {  // Offset inside target sphere
        reached = false;
        job.offset = vox::simd_math::simd_float4::Load(0.f, vox::simd_math::kSqrt2_2, 0.f, 0.f);
        EXPECT_TRUE(job.Run());
        const vox::QuaternionF z_Pi_4 =
                vox::QuaternionF::FromAxisAngle(vox::Vector3F::z_axis(), -vox::simd_math::kPi_4);
        EXPECT_SIMDQUATERNION_EQ_TOL(quat, z_Pi_4.x, z_Pi_4.y, z_Pi_4.z, z_Pi_4.w, 2e-3f);
    ...
    {  // Offset inside target sphere
        ...
        EXPECT_TRUE(job.Run());
        const vox::QuaternionF z_Pi_6 =
                vox::QuaternionF::FromAxisAngle(vox::Vector3F::z_axis(), -vox::simd_math::kPi / 6.f);
    ...
    {  // Offset inside target sphere
        ...
        EXPECT_TRUE(job.Run());
        const vox::QuaternionF y_Pi_6 =
                vox::QuaternionF::FromAxisAngle(vox::Vector3F::y_axis(), vox::simd_math::kPi / 6.f);
    ...
    {  // Offset on target sphere
        ...
        const vox::QuaternionF z_Pi_2 =
                vox::QuaternionF::FromAxisAngle(vox::Vector3F::z_axis(), -vox::simd_math::kPi_2);
...
TEST(Twist, IKAimJob) {
    ...
    {  // Pole y, twist -pi
        ...
        job.twist_angle = -vox::simd_math::kPi;
        EXPECT_TRUE(job.Run());
        const vox::QuaternionF x_mPi = vox::QuaternionF::FromAxisAngle(vox::Vector3F::x_axis(), -vox::simd_math::kPi);
...
TEST(Weight, IKAimJob) {
    ...
    {  // Half weight
        job.weight = .5f;
        EXPECT_TRUE(job.Run());
        const vox::QuaternionF y_mPi4 =
                vox::QuaternionF::FromAxisAngle(vox::Vector3F::y_axis(), -vox::simd_math::kPi_4);
