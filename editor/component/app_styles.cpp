...
//    output["type"] = "THEME";
//    rapidjson::json colors;
//    rapidjson::json styles;
//    rapidjson::json color;
//    rapidjson::json tmp;
//    ImGuiStyle &style = ImGui::GetStyle();
//
//    for (int i = 0; i < ImGuiCol_COUNT; i++) {
//        const ImVec4 &col = style.Colors[i];
//        color = rapidjson::json();
//        color["x"] = col.x;
//        color["y"] = col.y;
//        color["z"] = col.z;
//        color["w"] = col.w;
...
void showStyleEditor(bool *pOpen) {
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None)) {
        ...
        if (ImGui::BeginTabItem("Colors")) {
            ...
            ImGui::SameLine();
            ImGui::BeginChild("##colors", ImVec2(0, 0), true, ImGuiWindowFlags_AlwaysVerticalScrollbar
