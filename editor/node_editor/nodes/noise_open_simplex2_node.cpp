...
#include "noise_open_simplex2_node.h"
...
NoiseOpenSimplex2Node::NoiseOpenSimplex2Node() {
...
NodeOutput NoiseOpenSimplex2Node::evaluate(NodeInputParam input, NodeEditorPin *pin) {
...
void NoiseOpenSimplex2Node::onRender() {
    drawHeader("Open Simplex 2 Noise");
