...
#include "noise_open_simplex2s_node.h"
...
NoiseOpenSimplex2SNode::NoiseOpenSimplex2SNode() {
...
NodeOutput NoiseOpenSimplex2SNode::evaluate(NodeInputParam input, NodeEditorPin *pin) {
...
void NoiseOpenSimplex2SNode::onRender() {
    drawHeader("Open Simplex 2S Noise");
