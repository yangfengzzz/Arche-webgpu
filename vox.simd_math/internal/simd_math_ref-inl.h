...
VOX_INLINE SimdFloat4 FromInt(_SimdInt4 _i) {
    const SimdFloat4 ret = {static_cast<float>(_i.x), static_cast<float>(_i.y), static_cast<float>(_i.z),
...
VOX_INLINE SimdFloat4 MAdd(_SimdFloat4 _a, _SimdFloat4 _b, _SimdFloat4 _c) {
    const SimdFloat4 ret = {_a.x * _b.x + _c.x, _a.y * _b.y + _c.y, _a.z * _b.z + _c.z, _a.w * _b.w + _c.w};
    return ret;
}
...
VOX_INLINE SimdFloat4 NMAdd(_SimdFloat4 _a, _SimdFloat4 _b, _SimdFloat4 _c) {
    const SimdFloat4 ret = {_c.x - _a.x * _b.x, _c.y - _a.y * _b.y, _c.z - _a.z * _b.z, _c.w - _a.w * _b.w};
    return ret;
}
...
VOX_INLINE SimdFloat4 Dot3(_SimdFloat4 _a, _SimdFloat4 _b) {
    const SimdFloat4 ret = {_a.x * _b.x + _a.y * _b.y + _a.z * _b.z, _a.x, _a.x, _a.x};
    return ret;
}

VOX_INLINE SimdFloat4 Dot4(_SimdFloat4 _a, _SimdFloat4 _b) {
    const SimdFloat4 ret = {_a.x * _b.x + _a.y * _b.y + _a.z * _b.z + _a.w * _b.w, _a.x, _a.x, _a.x};
    return ret;
}

VOX_INLINE SimdFloat4 Cross3(_SimdFloat4 _a, _SimdFloat4 _b) {
    const SimdFloat4 ret = {_a.y * _b.z - _a.z * _b.y, _a.z * _b.x - _a.x * _b.z, _a.x * _b.y - _a.y * _b.x, _a.x};
    return ret;
}
...
VOX_INLINE SimdFloat4 Sqrt(_SimdFloat4 _v) {
    const SimdFloat4 ret = {std::sqrt(_v.x), std::sqrt(_v.y), std::sqrt(_v.z), std::sqrt(_v.w)};
    return ret;
}
...
VOX_INLINE SimdFloat4 Abs(_SimdFloat4 _v) {
    const SimdFloat4 ret = {std::abs(_v.x), std::abs(_v.y), std::abs(_v.z), std::abs(_v.w)};
    return ret;
}

VOX_INLINE SimdInt4 Sign(_SimdFloat4 _v) {
    internal::SimdFI4 fi = {_v};
    const SimdInt4 ret = {fi.i.x & static_cast<int>(0x80000000), fi.i.y & static_cast<int>(0x80000000),
                          fi.i.z & static_cast<int>(0x80000000), fi.i.w & static_cast<int>(0x80000000)};
    return ret;
}
...
VOX_INLINE SimdFloat4 Normalize4(_SimdFloat4 _v) {
    ...
    assert(sq_len != 0.f && "_v is not normalizable");
    const float inv_len = 1.f / std::sqrt(sq_len);
    const SimdFloat4 ret = {_v.x * inv_len, _v.y * inv_len, _v.z * inv_len, _v.w * inv_len};
    return ret;
}
...
VOX_INLINE SimdFloat4 Lerp(_SimdFloat4 _a, _SimdFloat4 _b, _SimdFloat4 _alpha) {
    const SimdFloat4 ret = {(_b.x - _a.x) * _alpha.x + _a.x, (_b.y - _a.y) * _alpha.y + _a.y,
                            (_b.z - _a.z) * _alpha.z + _a.z, (_b.w - _a.w) * _alpha.w + _a.w};
    return ret;
}

VOX_INLINE SimdFloat4 Min(_SimdFloat4 _a, _SimdFloat4 _b) {
    const SimdFloat4 ret = {_a.x < _b.x ? _a.x : _b.x, _a.y < _b.y ? _a.y : _b.y, _a.z < _b.z ? _a.z : _b.z,
                            _a.w < _b.w ? _a.w : _b.w};
    return ret;
}
...
VOX_INLINE SimdFloat4 Min0(_SimdFloat4 _v) {
    const SimdFloat4 ret = {_v.x < 0.f ? _v.x : 0.f, _v.y < 0.f ? _v.y : 0.f, _v.z < 0.f ? _v.z : 0.f,
                            _v.w < 0.f ? _v.w : 0.f};
    return ret;
}
...
VOX_INLINE SimdFloat4 Clamp(_SimdFloat4 _a, _SimdFloat4 _v, _SimdFloat4 _b) {
    const SimdFloat4 min = {_v.x < _b.x ? _v.x : _b.x, _v.y < _b.y ? _v.y : _b.y, _v.z < _b.z ? _v.z : _b.z,
                            _v.w < _b.w ? _v.w : _b.w};
    const SimdFloat4 r = {_a.x > min.x ? _a.x : min.x, _a.y > min.y ? _a.y : min.y, _a.z > min.z ? _a.z : min.z,
...
VOX_INLINE SimdFloat4 Select(_SimdInt4 _b, _SimdFloat4 _true, _SimdFloat4 _false) {
    ...
    const SimdIF4 ret = {
            {i_false.i.x ^ (_b.x & (i_true.i.x ^ i_false.i.x)), i_false.i.y ^ (_b.y & (i_true.i.y ^ i_false.i.y)),
             i_false.i.z ^ (_b.z & (i_true.i.z ^ i_false.i.z)), i_false.i.w ^ (_b.w & (i_true.i.w ^ i_false.i.w))}};
    return ret.f;
}

VOX_INLINE SimdInt4 CmpEq(_SimdFloat4 _a, _SimdFloat4 _b) {
    const SimdInt4 ret = {-static_cast<int>(_a.x == _b.x), -static_cast<int>(_a.y == _b.y),
...
VOX_INLINE SimdFloat4 And(_SimdFloat4 _a, _SimdFloat4 _b) {
    ...
    const internal::SimdIF4 ret = {{a.i.x & b.i.x, a.i.y & b.i.y, a.i.z & b.i.z, a.i.w & b.i.w}};
    return ret.f;
}
...
VOX_INLINE SimdFloat4 And(_SimdFloat4 _a, _SimdInt4 _b) {
    const internal::SimdFI4 a = {_a};
    const internal::SimdIF4 ret = {{a.i.x & _b.x, a.i.y & _b.y, a.i.z & _b.z, a.i.w & _b.w}};
    return ret.f;
}
...
VOX_INLINE SimdFloat4 Cos(_SimdFloat4 _v) {
    const SimdFloat4 ret = {std::cos(_v.x), std::cos(_v.y), std::cos(_v.z), std::cos(_v.w)};
    return ret;
}
...
VOX_INLINE SimdFloat4 Sin(_SimdFloat4 _v) {
    const SimdFloat4 ret = {std::sin(_v.x), std::sin(_v.y), std::sin(_v.z), std::sin(_v.w)};
    return ret;
}
...
VOX_INLINE SimdFloat4 Tan(_SimdFloat4 _v) {
    const SimdFloat4 ret = {std::tan(_v.x), std::tan(_v.y), std::tan(_v.z), std::tan(_v.w)};
    return ret;
}
...
VOX_INLINE SimdInt4 mask_sign() {
    const SimdInt4 ret = {static_cast<int>(0x80000000), static_cast<int>(0x80000000), static_cast<int>(0x80000000),
...
VOX_INLINE SimdInt4 mask_sign_w() {
    const SimdInt4 ret = {static_cast<int>(0x00000000), static_cast<int>(0x00000000), static_cast<int>(0x00000000),
                          static_cast<int>(0x80000000)};
    return ret;
}

VOX_INLINE SimdInt4 mask_not_sign() {
    const SimdInt4 ret = {static_cast<int>(0x7fffffff), static_cast<int>(0x7fffffff), static_cast<int>(0x7fffffff),
...
VOX_INLINE SimdInt4 Load(bool _x, bool _y, bool _z, bool _w) {
    const SimdInt4 ret = {-static_cast<int>(_x), -static_cast<int>(_y), -static_cast<int>(_z), -static_cast<int>(_w)};
    return ret;
}
...
VOX_INLINE SimdInt4 FromFloatTrunc(_SimdFloat4 _f) {
    const SimdInt4 ret = {static_cast<int>(_f.x), static_cast<int>(_f.y), static_cast<int>(_f.z),
...
VOX_INLINE int MoveMask(_SimdInt4 _v) {
    return ((_v.x & 0x80000000) >> 31) | ((_v.y & 0x80000000) >> 30) | ((_v.z & 0x80000000) >> 29) |
           ((_v.w & 0x80000000) >> 28);
}

VOX_INLINE bool AreAllTrue(_SimdInt4 _v) { return _v.x != 0 && _v.y != 0 && _v.z != 0 && _v.w != 0; }

VOX_INLINE bool AreAllTrue3(_SimdInt4 _v) { return _v.x != 0 && _v.y != 0 && _v.z != 0; }

VOX_INLINE bool AreAllTrue2(_SimdInt4 _v) { return _v.x != 0 && _v.y != 0; }

VOX_INLINE bool AreAllTrue1(_SimdInt4 _v) { return _v.x != 0; }

VOX_INLINE bool AreAllFalse(_SimdInt4 _v) { return _v.x == 0 && _v.y == 0 && _v.z == 0 && _v.w == 0; }

VOX_INLINE bool AreAllFalse3(_SimdInt4 _v) { return _v.x == 0 && _v.y == 0 && _v.z == 0; }
...
VOX_INLINE SimdInt4 MAdd(_SimdInt4 _a, _SimdInt4 _b, _SimdInt4 _addend) {
    const SimdInt4 ret = {_a.x * _b.x + _addend.x, _a.y * _b.y + _addend.y, _a.z * _b.z + _addend.z,
                          _a.w * _b.w + _addend.w};
    return ret;
}
...
VOX_INLINE SimdInt4 Dot3(_SimdInt4 _a, _SimdInt4 _b) {
    const SimdInt4 ret = {_a.x * _b.x + _a.y * _b.y + _a.z * _b.z, _a.y, _a.z, _a.w};
    return ret;
}

VOX_INLINE SimdInt4 Dot4(_SimdInt4 _a, _SimdInt4 _b) {
    const SimdInt4 ret = {_a.x * _b.x + _a.y * _b.y + _a.z * _b.z + _a.w * _b.w, _a.y, _a.z, _a.w};
    return ret;
}
VOX_INLINE SimdInt4 Abs(_SimdInt4 _v) {
    const SimdInt4 mash = {_v.x >> 31, _v.y >> 31, _v.z >> 31, _v.w >> 31};
    const SimdInt4 ret = {(_v.x + (mash.x)) ^ (mash.x), (_v.y + (mash.y)) ^ (mash.y), (_v.z + (mash.z)) ^ (mash.z),
                          (_v.w + (mash.w)) ^ (mash.w)};
    return ret;
}

VOX_INLINE SimdInt4 Sign(_SimdInt4 _v) {
    const SimdInt4 ret = {_v.x & static_cast<int>(0x80000000), _v.y & static_cast<int>(0x80000000),
                          _v.z & static_cast<int>(0x80000000), _v.w & static_cast<int>(0x80000000)};
    return ret;
}

VOX_INLINE SimdInt4 Min(_SimdInt4 _a, _SimdInt4 _b) {
    const SimdInt4 ret = {_a.x < _b.x ? _a.x : _b.x, _a.y < _b.y ? _a.y : _b.y, _a.z < _b.z ? _a.z : _b.z,
                          _a.w < _b.w ? _a.w : _b.w};
    return ret;
}
...
VOX_INLINE SimdInt4 Min0(_SimdInt4 _v) {
    const SimdInt4 ret = {_v.x < 0 ? _v.x : 0, _v.y < 0 ? _v.y : 0, _v.z < 0 ? _v.z : 0, _v.w < 0 ? _v.w : 0};
    return ret;
}
...
VOX_INLINE SimdInt4 Clamp(_SimdInt4 _a, _SimdInt4 _v, _SimdInt4 _b) {
    const SimdInt4 min = {_v.x < _b.x ? _v.x : _b.x, _v.y < _b.y ? _v.y : _b.y, _v.z < _b.z ? _v.z : _b.z,
                          _v.w < _b.w ? _v.w : _b.w};
    const SimdInt4 r = {_a.x > min.x ? _a.x : min.x, _a.y > min.y ? _a.y : min.y, _a.z > min.z ? _a.z : min.z,
                        _a.w > min.w ? _a.w : min.w};
    return r;
}

VOX_INLINE SimdInt4 Select(_SimdInt4 _b, _SimdInt4 _true, _SimdInt4 _false) {
    const SimdInt4 ret = {_false.x ^ (_b.x & (_true.x ^ _false.x)), _false.y ^ (_b.y & (_true.y ^ _false.y)),
                          _false.z ^ (_b.z & (_true.z ^ _false.z)), _false.w ^ (_b.w & (_true.w ^ _false.w))};
    return ret;
}
...
VOX_INLINE SimdInt4 ShiftL(_SimdInt4 _v, int _bits) {
    const SimdInt4 ret = {_v.x << _bits, _v.y << _bits, _v.z << _bits, _v.w << _bits};
    return ret;
}
...
VOX_INLINE SimdInt4 ShiftRu(_SimdInt4 _v, int _bits) {
    ...
    const union UI {
        unsigned int u[4];
        int i[4];
    } ui = {{iu.u[0] >> _bits, iu.u[1] >> _bits, iu.u[2] >> _bits, iu.u[3] >> _bits}};
...
VOX_INLINE Float4x4 Float4x4::identity() {
    const Float4x4 ret = {{{1.f, 0.f, 0.f, 0.f}, {0.f, 1.f, 0.f, 0.f}, {0.f, 0.f, 1.f, 0.f}, {0.f, 0.f, 0.f, 1.f}}};
    return ret;
}

VOX_INLINE Float4x4 Transpose(const Float4x4& _m) {
    const Float4x4 ret = {{{_m.cols[0].x, _m.cols[1].x, _m.cols[2].x, _m.cols[3].x},
...
VOX_INLINE Float4x4 Invert(const Float4x4& _m, SimdInt4* _invertible) {
    ...
    const float det = cols[0].x * b0x + cols[0].y * b1x + cols[0].z * b2x + cols[0].w * b3x;
    ...
    const Float4x4 ret = {{{b0x * inv_det, b0y * inv_det, b0z * inv_det, b0w * inv_det},
...
Float4x4 Float4x4::Scaling(_SimdFloat4 _v) {
    const Float4x4 ret = {{{_v.x, 0.f, 0.f, 0.f}, {0.f, _v.y, 0.f, 0.f}, {0.f, 0.f, _v.z, 0.f}, {0.f, 0.f, 0.f, 1.f}}};
    return ret;
}

Float4x4 Float4x4::Translation(_SimdFloat4 _v) {
    const Float4x4 ret = {{{1.f, 0.f, 0.f, 0.f}, {0.f, 1.f, 0.f, 0.f}, {0.f, 0.f, 1.f, 0.f}, {_v.x, _v.y, _v.z, 1.f}}};
    return ret;
}
...
VOX_INLINE Float4x4 Translate(const Float4x4& _m, _SimdFloat4 _v) {
    const Float4x4 ret = {{_m.cols[0],
                           _m.cols[1],
                           _m.cols[2],
                           {_m.cols[0].x * _v.x + _m.cols[1].x * _v.y + _m.cols[2].x * _v.z + _m.cols[3].x,
...
VOX_INLINE Float4x4 Scale(const Float4x4& _m, _SimdFloat4 _v) {
    const Float4x4 ret = {{{_m.cols[0].x * _v.x, _m.cols[0].y * _v.x, _m.cols[0].z * _v.x, _m.cols[0].w * _v.x},
                           {_m.cols[1].x * _v.y, _m.cols[1].y * _v.y, _m.cols[1].z * _v.y, _m.cols[1].w * _v.y},
                           {_m.cols[2].x * _v.z, _m.cols[2].y * _v.z, _m.cols[2].z * _v.z, _m.cols[2].w * _v.z},
                           _m.cols[3]}};
    return ret;
}

VOX_INLINE Float4x4 ColumnMultiply(const Float4x4& _m, _SimdFloat4 _v) {
    const Float4x4 ret = {{{_m.cols[0].x * _v.x, _m.cols[0].y * _v.y, _m.cols[0].z * _v.z, _m.cols[0].w * _v.w},
                           {_m.cols[1].x * _v.x, _m.cols[1].y * _v.y, _m.cols[1].z * _v.z, _m.cols[1].w * _v.w},
                           {_m.cols[2].x * _v.x, _m.cols[2].y * _v.y, _m.cols[2].z * _v.z, _m.cols[2].w * _v.w},
                           {_m.cols[3].x * _v.x, _m.cols[3].y * _v.y, _m.cols[3].z * _v.z, _m.cols[3].w * _v.w}}};
    return ret;
}

VOX_INLINE SimdInt4 IsNormalized(const Float4x4& _m) {
    const SimdInt4 ret = {IsNormalized3(_m.cols[0]).x, IsNormalized3(_m.cols[1]).x, IsNormalized3(_m.cols[2]).x, 0};
    return ret;
}

VOX_INLINE SimdInt4 IsNormalizedEst(const Float4x4& _m) {
    const SimdInt4 ret = {IsNormalizedEst3(_m.cols[0]).x, IsNormalizedEst3(_m.cols[1]).x,
...
VOX_INLINE SimdInt4 IsOrthogonal(const Float4x4& _m) {
    ...
    const SimdFloat4 cross = NormalizeSafe3(Cross3(_m.cols[0], _m.cols[1]), simd_float4::zero());
...
VOX_INLINE bool ToAffine(const Float4x4& _m, SimdFloat4* _translation, SimdFloat4* _quaternion, SimdFloat4* _scale) {
    ...
    _scale->x = Dot3(orthonormal.cols[0], _m.cols[0]).x > 0.f ? scale_x : -scale_x;
    _scale->y = Dot3(orthonormal.cols[1], _m.cols[1]).x > 0.f ? scale_y : -scale_y;
    _scale->z = Dot3(orthonormal.cols[2], _m.cols[2]).x > 0.f ? scale_z : -scale_z;
    _scale->w = 1.f;
...
VOX_INLINE Float4x4 Float4x4::FromAxisAngle(_SimdFloat4 _axis, _SimdFloat4 _angle) {
...
VOX_INLINE Float4x4 Float4x4::FromQuaternion(_SimdFloat4 _v) {
    ...
    const Float4x4 ret = {{{1.f - 2.f * (yy + zz), 2.f * (xy + zw), 2.f * (xz - yw), 0.f},
...
VOX_INLINE Float4x4 Float4x4::FromAffine(_SimdFloat4 _translation, _SimdFloat4 _quaternion, _SimdFloat4 _scale) {
    ...
    const Float4x4 ret = {
            {{_scale.x * (1.f - 2.f * (yy + zz)), _scale.x * 2.f * (xy + zw), _scale.x * 2.f * (xz - yw), 0.f},
             {_scale.y * 2.f * (xy - zw), _scale.y * (1.f - 2.f * (xx + zz)), _scale.y * (2.f * (yz + xw)), 0.f},
             {_scale.z * 2.f * (xz + yw), _scale.z * 2.f * (yz - xw), _scale.z * (1.f - 2.f * (xx + yy)), 0.f},
