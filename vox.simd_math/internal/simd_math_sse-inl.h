...
#ifdef VOX_SIMD_AVX
#define VOX_SHUFFLE_PS1(_v, _m) _mm_permute_ps(_v, _m)
#else  // VOX_SIMD_AVX
#define VOX_SHUFFLE_PS1(_v, _m) _mm_shuffle_ps(_v, _v, _m)
#endif  // VOX_SIMD_AVX

#define VOX_SSE_SPLAT_F(_v, _i) VOX_SHUFFLE_PS1(_v, _MM_SHUFFLE(_i, _i, _i, _i))

#define VOX_SSE_SPLAT_I(_v, _i) _mm_shuffle_epi32(_v, _MM_SHUFFLE(_i, _i, _i, _i))

// _v.x + _v.y, _v.y, _v.z, _v.w
#define VOX_SSE_HADD2_F(_v) _mm_add_ss(_v, VOX_SSE_SPLAT_F(_v, 1))

// _v.x + _v.y + _v.z, _v.y, _v.z, _v.w
#define VOX_SSE_HADD3_F(_v) _mm_add_ss(_mm_add_ss(_v, VOX_SSE_SPLAT_F(_v, 2)), VOX_SSE_SPLAT_F(_v, 1))

// _v.x + _v.y + _v.z + _v.w, ?, ?, ?
#define VOX_SSE_HADD4_F(_v, _r)                                        \
    do {                                                               \
        const __m128 haddxyzw = _mm_add_ps(_v, _mm_movehl_ps(_v, _v)); \
        _r = _mm_add_ss(haddxyzw, VOX_SSE_SPLAT_F(haddxyzw, 1));       \
    } while (void(0), 0)

// dot2, ?, ?, ?
#define VOX_SSE_DOT2_F(_a, _b, _r)                   \
    do {                                             \
        const __m128 ab = _mm_mul_ps(_a, _b);        \
        _r = _mm_add_ss(ab, VOX_SSE_SPLAT_F(ab, 1)); \
                                                     \
    } while (void(0), 0)

#ifdef VOX_SIMD_SSE4_1
// dot3, ?, ?, ?
#define VOX_SSE_DOT3_F(_a, _b, _r)    \
    do {                              \
        _r = _mm_dp_ps(_a, _b, 0x7f); \
    } while (void(0), 0)

// dot4, ?, ?, ?
#define VOX_SSE_DOT4_F(_a, _b, _r)    \
    do {                              \
        _r = _mm_dp_ps(_a, _b, 0xff); \
    } while (void(0), 0)

#else  // VOX_SIMD_SSE4_1
// dot3, ?, ?, ?
#define VOX_SSE_DOT3_F(_a, _b, _r)            \
    do {                                      \
        const __m128 ab = _mm_mul_ps(_a, _b); \
        _r = VOX_SSE_HADD3_F(ab);             \
    } while (void(0), 0)
...
#define VOX_SSE_DOT4_F(_a, _b, _r)            \
    do {                                      \
        const __m128 ab = _mm_mul_ps(_a, _b); \
        VOX_SSE_HADD4_F(ab, _r);              \
    } while (void(0), 0)
#endif  // VOX_SIMD_SSE4_1

// FMA operations
#ifdef VOX_SIMD_FMA
#define VOX_MADD(_a, _b, _c) _mm_fmadd_ps(_a, _b, _c)
#define VOX_MSUB(_a, _b, _c) _mm_fmsub_ps(_a, _b, _c)
#define VOX_NMADD(_a, _b, _c) _mm_fnmadd_ps(_a, _b, _c)
#define VOX_NMSUB(_a, _b, _c) _mm_fnmsub_ps(_a, _b, _c)
#define VOX_MADDX(_a, _b, _c) _mm_fmadd_ss(_a, _b, _c)
#define VOX_MSUBX(_a, _b, _c) _mm_fmsub_ss(_a, _b, _c)
#define VOX_NMADDX(_a, _b, _c) _mm_fnmadd_ss(_a, _b, _c)
#define VOX_NMSUBX(_a, _b, _c) _mm_fnmsub_ss(_a, _b, _c)
#else  //  VOX_SIMD_FMA
#define VOX_MADD(_a, _b, _c) _mm_add_ps(_mm_mul_ps(_a, _b), _c)
#define VOX_MSUB(_a, _b, _c) _mm_sub_ps(_mm_mul_ps(_a, _b), _c)
#define VOX_NMADD(_a, _b, _c) _mm_sub_ps(_c, _mm_mul_ps(_a, _b))
#define VOX_NMSUB(_a, _b, _c) (-_mm_add_ps(_mm_mul_ps(_a, _b), _c))
#define VOX_MADDX(_a, _b, _c) _mm_add_ss(_mm_mul_ss(_a, _b), _c)
#define VOX_MSUBX(_a, _b, _c) _mm_sub_ss(_mm_mul_ss(_a, _b), _c)
#define VOX_NMADDX(_a, _b, _c) _mm_sub_ss(_c, _mm_mul_ss(_a, _b))
#define VOX_NMSUBX(_a, _b, _c) (-_mm_add_ss(_mm_mul_ss(_a, _b), _c))
#endif  // VOX_SIMD_FMA

VOX_INLINE SimdFloat4 DivX(_SimdFloat4 _a, _SimdFloat4 _b) { return _mm_div_ss(_a, _b); }

#ifdef VOX_SIMD_SSE4_1

#define VOX_SSE_SELECT_F(_b, _true, _false) _mm_blendv_ps(_false, _true, _mm_castsi128_ps(_b))

#define VOX_SSE_SELECT_I(_b, _true, _false) _mm_blendv_epi8(_false, _true, _b)

#else  // VOX_SIMD_SSE4_1

#define VOX_SSE_SELECT_F(_b, _true, _false) \
    _mm_or_ps(_mm_and_ps(_true, _mm_castsi128_ps(_b)), _mm_andnot_ps(_mm_castsi128_ps(_b), _false))

#define VOX_SSE_SELECT_I(_b, _true, _false) _mm_or_si128(_mm_and_si128(_true, _b), _mm_andnot_si128(_b, _false))

#endif  // VOX_SIMD_SSE4_1

VOX_INLINE SimdFloat4 zero() { return _mm_setzero_ps(); }
...
VOX_INLINE SimdFloat4 Load(float _x, float _y, float _z, float _w) { return _mm_set_ps(_w, _z, _y, _x); }

VOX_INLINE SimdFloat4 LoadX(float _x) { return _mm_set_ss(_x); }

VOX_INLINE SimdFloat4 Load1(float _x) { return _mm_set_ps1(_x); }
...
VOX_INLINE SimdFloat4 FromInt(_SimdInt4 _i) { return _mm_cvtepi32_ps(_i); }
}  // namespace simd_float4

VOX_INLINE float GetX(_SimdFloat4 _v) { return _mm_cvtss_f32(_v); }

VOX_INLINE float GetY(_SimdFloat4 _v) { return _mm_cvtss_f32(VOX_SSE_SPLAT_F(_v, 1)); }

VOX_INLINE float GetZ(_SimdFloat4 _v) { return _mm_cvtss_f32(_mm_movehl_ps(_v, _v)); }

VOX_INLINE float GetW(_SimdFloat4 _v) { return _mm_cvtss_f32(VOX_SSE_SPLAT_F(_v, 3)); }

VOX_INLINE SimdFloat4 SetX(_SimdFloat4 _v, _SimdFloat4 _f) { return _mm_move_ss(_v, _f); }
...
VOX_INLINE void Store2PtrU(_SimdFloat4 _v, float* _f) {
    ...
    _mm_store_ss(_f + 1, VOX_SSE_SPLAT_F(_v, 1));
}
...
VOX_INLINE SimdFloat4 SplatX(_SimdFloat4 _v) { return VOX_SSE_SPLAT_F(_v, 0); }

VOX_INLINE SimdFloat4 SplatY(_SimdFloat4 _v) { return VOX_SSE_SPLAT_F(_v, 1); }

VOX_INLINE SimdFloat4 SplatZ(_SimdFloat4 _v) { return VOX_SSE_SPLAT_F(_v, 2); }

VOX_INLINE SimdFloat4 SplatW(_SimdFloat4 _v) { return VOX_SSE_SPLAT_F(_v, 3); }
...
VOX_INLINE SimdFloat4 Swizzle(_SimdFloat4 _v) {
    ...
    return VOX_SHUFFLE_PS1(_v, _MM_SHUFFLE(_W, _Z, _Y, _X));
}

template <>
VOX_INLINE SimdFloat4 Swizzle<0, 1, 2, 3>(_SimdFloat4 _v) {
    return _v;
}

template <>
VOX_INLINE SimdFloat4 Swizzle<0, 1, 0, 1>(_SimdFloat4 _v) {
    return _mm_movelh_ps(_v, _v);
}

template <>
VOX_INLINE SimdFloat4 Swizzle<2, 3, 2, 3>(_SimdFloat4 _v) {
    return _mm_movehl_ps(_v, _v);
}

template <>
VOX_INLINE SimdFloat4 Swizzle<0, 0, 1, 1>(_SimdFloat4 _v) {
    return _mm_unpacklo_ps(_v, _v);
}

template <>
VOX_INLINE SimdFloat4 Swizzle<2, 2, 3, 3>(_SimdFloat4 _v) {
...
VOX_INLINE void Transpose1x4(const SimdFloat4 _in[1], SimdFloat4 _out[4]) {
    ...
    const __m128 yyyy = VOX_SSE_SPLAT_F(_in[0], 1);
    const __m128 wwww = VOX_SSE_SPLAT_F(_in[0], 3);
...
VOX_INLINE SimdFloat4 MAdd(_SimdFloat4 _a, _SimdFloat4 _b, _SimdFloat4 _c) { return VOX_MADD(_a, _b, _c); }

VOX_INLINE SimdFloat4 MSub(_SimdFloat4 _a, _SimdFloat4 _b, _SimdFloat4 _c) { return VOX_MSUB(_a, _b, _c); }

VOX_INLINE SimdFloat4 NMAdd(_SimdFloat4 _a, _SimdFloat4 _b, _SimdFloat4 _c) { return VOX_NMADD(_a, _b, _c); }

VOX_INLINE SimdFloat4 NMSub(_SimdFloat4 _a, _SimdFloat4 _b, _SimdFloat4 _c) { return VOX_NMSUB(_a, _b, _c); }

VOX_INLINE SimdFloat4 DivX(_SimdFloat4 _a, _SimdFloat4 _b) { return _mm_div_ss(_a, _b); }

VOX_INLINE SimdFloat4 HAdd2(_SimdFloat4 _v) { return VOX_SSE_HADD2_F(_v); }

VOX_INLINE SimdFloat4 HAdd3(_SimdFloat4 _v) { return VOX_SSE_HADD3_F(_v); }

VOX_INLINE SimdFloat4 HAdd4(_SimdFloat4 _v) {
    __m128 hadd4;
    VOX_SSE_HADD4_F(_v, hadd4);
    return hadd4;
}

VOX_INLINE SimdFloat4 Dot2(_SimdFloat4 _a, _SimdFloat4 _b) {
    __m128 dot2;
    VOX_SSE_DOT2_F(_a, _b, dot2);
    return dot2;
}

VOX_INLINE SimdFloat4 Dot3(_SimdFloat4 _a, _SimdFloat4 _b) {
    __m128 dot3;
    VOX_SSE_DOT3_F(_a, _b, dot3);
    return dot3;
}

VOX_INLINE SimdFloat4 Dot4(_SimdFloat4 _a, _SimdFloat4 _b) {
    __m128 dot4;
    VOX_SSE_DOT4_F(_a, _b, dot4);
    return dot4;
}
...
VOX_INLINE SimdFloat4 Cross3(_SimdFloat4 _a, _SimdFloat4 _b) {
    ...
    const __m128 shufa = VOX_SHUFFLE_PS1(_a, _MM_SHUFFLE(3, 0, 2, 1));
    const __m128 shufb = VOX_SHUFFLE_PS1(_b, _MM_SHUFFLE(3, 0, 2, 1));
    const __m128 shufc = VOX_MSUB(_a, shufb, _mm_mul_ps(_b, shufa));
    return VOX_SHUFFLE_PS1(shufc, _MM_SHUFFLE(3, 0, 2, 1));
}

VOX_INLINE SimdFloat4 RcpEst(_SimdFloat4 _v) { return _mm_rcp_ps(_v); }
...
VOX_INLINE SimdFloat4 RcpEstNR(_SimdFloat4 _v) {
    ...
    return VOX_NMADD(_mm_mul_ps(nr, nr), _v, _mm_add_ps(nr, nr));
}

VOX_INLINE SimdFloat4 RcpEstX(_SimdFloat4 _v) { return _mm_rcp_ss(_v); }

VOX_INLINE SimdFloat4 RcpEstXNR(_SimdFloat4 _v) {
    const __m128 nr = _mm_rcp_ss(_v);
    // Do one more Newton-Raphson step to improve precision.
    return VOX_NMADDX(_mm_mul_ss(nr, nr), _v, _mm_add_ss(nr, nr));
}

VOX_INLINE SimdFloat4 Sqrt(_SimdFloat4 _v) { return _mm_sqrt_ps(_v); }

VOX_INLINE SimdFloat4 SqrtX(_SimdFloat4 _v) { return _mm_sqrt_ss(_v); }

VOX_INLINE SimdFloat4 RSqrtEst(_SimdFloat4 _v) { return _mm_rsqrt_ps(_v); }

VOX_INLINE SimdFloat4 RSqrtEstNR(_SimdFloat4 _v) {
    const __m128 nr = _mm_rsqrt_ps(_v);
    // Do one more Newton-Raphson step to improve precision.
    return _mm_mul_ps(_mm_mul_ps(_mm_set_ps1(.5f), nr), VOX_NMADD(_mm_mul_ps(_v, nr), nr, _mm_set_ps1(3.f)));
}

VOX_INLINE SimdFloat4 RSqrtEstX(_SimdFloat4 _v) { return _mm_rsqrt_ss(_v); }

VOX_INLINE SimdFloat4 RSqrtEstXNR(_SimdFloat4 _v) {
    const __m128 nr = _mm_rsqrt_ss(_v);
    // Do one more Newton-Raphson step to improve precision.
    return _mm_mul_ss(_mm_mul_ss(_mm_set_ps1(.5f), nr), VOX_NMADDX(_mm_mul_ss(_v, nr), nr, _mm_set_ps1(3.f)));
}
...
VOX_INLINE SimdInt4 Sign(_SimdFloat4 _v) { return _mm_slli_epi32(_mm_srli_epi32(_mm_castps_si128(_v), 31), 31); }

VOX_INLINE SimdFloat4 Length2(_SimdFloat4 _v) {
    __m128 sq_len;
    VOX_SSE_DOT2_F(_v, _v, sq_len);
    return _mm_sqrt_ss(sq_len);
}

VOX_INLINE SimdFloat4 Length3(_SimdFloat4 _v) {
    __m128 sq_len;
    VOX_SSE_DOT3_F(_v, _v, sq_len);
    return _mm_sqrt_ss(sq_len);
}

VOX_INLINE SimdFloat4 Length4(_SimdFloat4 _v) {
    __m128 sq_len;
    VOX_SSE_DOT4_F(_v, _v, sq_len);
    return _mm_sqrt_ss(sq_len);
}
...
VOX_INLINE SimdFloat4 Normalize2(_SimdFloat4 _v) {
    ...
    const __m128 inv_lenxxxx = VOX_SSE_SPLAT_F(inv_len, 0);
...
VOX_INLINE SimdFloat4 Normalize3(_SimdFloat4 _v) {
    ...
    assert(_mm_cvtss_f32(sq_len) != 0.f && "_v is not normalizable");
    const __m128 inv_len = _mm_div_ss(simd_float4::one(), _mm_sqrt_ss(sq_len));
    const __m128 vwxyz = VOX_SHUFFLE_PS1(_v, _MM_SHUFFLE(0, 1, 2, 3));
    const __m128 inv_lenxxxx = VOX_SSE_SPLAT_F(inv_len, 0);
    const __m128 normwxyz = _mm_move_ss(_mm_mul_ps(vwxyz, inv_lenxxxx), vwxyz);
    return VOX_SHUFFLE_PS1(normwxyz, _MM_SHUFFLE(0, 1, 2, 3));
}
...
VOX_INLINE SimdFloat4 NormalizeSafe2(_SimdFloat4 _v, _SimdFloat4 _safe) {
    ...
    const __m128 inv_lenxxxx = VOX_SSE_SPLAT_F(inv_len, 0);
    const __m128 norm = _mm_mul_ps(_v, inv_lenxxxx);
    const __m128i cond = _mm_castps_si128(_mm_cmple_ps(VOX_SSE_SPLAT_F(sq_len, 0), _mm_setzero_ps()));
    const __m128 cfalse = _mm_movelh_ps(norm, _mm_movehl_ps(_v, _v));
    return VOX_SSE_SELECT_F(cond, _safe, cfalse);
}
...
VOX_INLINE SimdFloat4 NormalizeSafe3(_SimdFloat4 _v, _SimdFloat4 _safe) {
    ...
    const __m128 normwxyz = _mm_move_ss(_mm_mul_ps(vwxyz, inv_lenxxxx), vwxyz);
    const __m128i cond = _mm_castps_si128(_mm_cmple_ps(VOX_SSE_SPLAT_F(sq_len, 0), _mm_setzero_ps()));
    const __m128 cfalse = VOX_SHUFFLE_PS1(normwxyz, _MM_SHUFFLE(0, 1, 2, 3));
    return VOX_SSE_SELECT_F(cond, _safe, cfalse);
}
...
VOX_INLINE SimdFloat4 Lerp(_SimdFloat4 _a, _SimdFloat4 _b, _SimdFloat4 _alpha) {
    return VOX_MADD(_alpha, _mm_sub_ps(_b, _a), _a);
}

VOX_INLINE SimdFloat4 Min(_SimdFloat4 _a, _SimdFloat4 _b) { return _mm_min_ps(_a, _b); }

VOX_INLINE SimdFloat4 Max(_SimdFloat4 _a, _SimdFloat4 _b) { return _mm_max_ps(_a, _b); }

VOX_INLINE SimdFloat4 Min0(_SimdFloat4 _v) { return _mm_min_ps(_mm_setzero_ps(), _v); }

VOX_INLINE SimdFloat4 Max0(_SimdFloat4 _v) { return _mm_max_ps(_mm_setzero_ps(), _v); }
...
VOX_INLINE SimdFloat4 Select(_SimdInt4 _b, _SimdFloat4 _true, _SimdFloat4 _false) {
    return VOX_SSE_SELECT_F(_b, _true, _false);
}

VOX_INLINE SimdInt4 CmpEq(_SimdFloat4 _a, _SimdFloat4 _b) { return _mm_castps_si128(_mm_cmpeq_ps(_a, _b)); }

VOX_INLINE SimdInt4 CmpNe(_SimdFloat4 _a, _SimdFloat4 _b) { return _mm_castps_si128(_mm_cmpneq_ps(_a, _b)); }

VOX_INLINE SimdInt4 CmpLt(_SimdFloat4 _a, _SimdFloat4 _b) { return _mm_castps_si128(_mm_cmplt_ps(_a, _b)); }

VOX_INLINE SimdInt4 CmpLe(_SimdFloat4 _a, _SimdFloat4 _b) { return _mm_castps_si128(_mm_cmple_ps(_a, _b)); }

VOX_INLINE SimdInt4 CmpGt(_SimdFloat4 _a, _SimdFloat4 _b) { return _mm_castps_si128(_mm_cmpgt_ps(_a, _b)); }

VOX_INLINE SimdInt4 CmpGe(_SimdFloat4 _a, _SimdFloat4 _b) { return _mm_castps_si128(_mm_cmpge_ps(_a, _b)); }

VOX_INLINE SimdFloat4 And(_SimdFloat4 _a, _SimdFloat4 _b) { return _mm_and_ps(_a, _b); }

VOX_INLINE SimdFloat4 Or(_SimdFloat4 _a, _SimdFloat4 _b) { return _mm_or_ps(_a, _b); }

VOX_INLINE SimdFloat4 Xor(_SimdFloat4 _a, _SimdFloat4 _b) { return _mm_xor_ps(_a, _b); }

VOX_INLINE SimdFloat4 And(_SimdFloat4 _a, _SimdInt4 _b) { return _mm_and_ps(_a, _mm_castsi128_ps(_b)); }

VOX_INLINE SimdFloat4 AndNot(_SimdFloat4 _a, _SimdInt4 _b) { return _mm_andnot_ps(_mm_castsi128_ps(_b), _a); }

VOX_INLINE SimdFloat4 Or(_SimdFloat4 _a, _SimdInt4 _b) { return _mm_or_ps(_a, _mm_castsi128_ps(_b)); }

VOX_INLINE SimdFloat4 Xor(_SimdFloat4 _a, _SimdInt4 _b) { return _mm_xor_ps(_a, _mm_castsi128_ps(_b)); }
...
VOX_INLINE SimdFloat4 CosX(_SimdFloat4 _v) { return _mm_move_ss(_v, _mm_set_ps1(std::cos(GetX(_v)))); }
...
VOX_INLINE SimdFloat4 ACosX(_SimdFloat4 _v) { return _mm_move_ss(_v, _mm_set_ps1(std::acos(GetX(_v)))); }
...
VOX_INLINE SimdFloat4 SinX(_SimdFloat4 _v) { return _mm_move_ss(_v, _mm_set_ps1(std::sin(GetX(_v)))); }
...
VOX_INLINE SimdFloat4 ASinX(_SimdFloat4 _v) { return _mm_move_ss(_v, _mm_set_ps1(std::asin(GetX(_v)))); }
...
VOX_INLINE SimdFloat4 TanX(_SimdFloat4 _v) { return _mm_move_ss(_v, _mm_set_ps1(std::tan(GetX(_v)))); }
...
VOX_INLINE SimdFloat4 ATanX(_SimdFloat4 _v) { return _mm_move_ss(_v, _mm_set_ps1(std::atan(GetX(_v)))); }

namespace simd_int4 {

VOX_INLINE SimdInt4 zero() { return _mm_setzero_si128(); }
...
VOX_INLINE SimdInt4 all_false() { return _mm_setzero_si128(); }
...
VOX_INLINE SimdInt4 mask_0000() { return _mm_setzero_si128(); }
...
VOX_INLINE SimdInt4 Load(int _x, int _y, int _z, int _w) { return _mm_set_epi32(_w, _z, _y, _x); }

VOX_INLINE SimdInt4 LoadX(int _x) { return _mm_set_epi32(0, 0, 0, _x); }

VOX_INLINE SimdInt4 Load1(int _x) { return _mm_set1_epi32(_x); }

VOX_INLINE SimdInt4 Load(bool _x, bool _y, bool _z, bool _w) {
    return _mm_sub_epi32(_mm_setzero_si128(), _mm_set_epi32(_w, _z, _y, _x));
}

VOX_INLINE SimdInt4 LoadX(bool _x) { return _mm_sub_epi32(_mm_setzero_si128(), _mm_set_epi32(0, 0, 0, _x)); }

VOX_INLINE SimdInt4 Load1(bool _x) { return _mm_sub_epi32(_mm_setzero_si128(), _mm_set1_epi32(_x)); }
...
VOX_INLINE SimdInt4 FromFloatRound(_SimdFloat4 _f) { return _mm_cvtps_epi32(_f); }

VOX_INLINE SimdInt4 FromFloatTrunc(_SimdFloat4 _f) { return _mm_cvttps_epi32(_f); }
}  // namespace simd_int4

VOX_INLINE int GetX(_SimdInt4 _v) { return _mm_cvtsi128_si32(_v); }

VOX_INLINE int GetY(_SimdInt4 _v) { return _mm_cvtsi128_si32(VOX_SSE_SPLAT_I(_v, 1)); }

VOX_INLINE int GetZ(_SimdInt4 _v) { return _mm_cvtsi128_si32(_mm_unpackhi_epi32(_v, _v)); }

VOX_INLINE int GetW(_SimdInt4 _v) { return _mm_cvtsi128_si32(VOX_SSE_SPLAT_I(_v, 3)); }
...
VOX_INLINE void Store2Ptr(_SimdInt4 _v, int* _i) {
    ...
    _i[1] = _mm_cvtsi128_si32(VOX_SSE_SPLAT_I(_v, 1));
}
...
VOX_INLINE SimdInt4 SplatX(_SimdInt4 _a) { return VOX_SSE_SPLAT_I(_a, 0); }

VOX_INLINE SimdInt4 SplatY(_SimdInt4 _a) { return VOX_SSE_SPLAT_I(_a, 1); }

VOX_INLINE SimdInt4 SplatZ(_SimdInt4 _a) { return VOX_SSE_SPLAT_I(_a, 2); }

VOX_INLINE SimdInt4 SplatW(_SimdInt4 _a) { return VOX_SSE_SPLAT_I(_a, 3); }
...
template <>
VOX_INLINE SimdInt4 Swizzle<0, 1, 2, 3>(_SimdInt4 _v) {
    return _v;
}

VOX_INLINE int MoveMask(_SimdInt4 _v) { return _mm_movemask_ps(_mm_castsi128_ps(_v)); }

VOX_INLINE bool AreAllTrue(_SimdInt4 _v) { return _mm_movemask_ps(_mm_castsi128_ps(_v)) == 0xf; }

VOX_INLINE bool AreAllTrue3(_SimdInt4 _v) { return (_mm_movemask_ps(_mm_castsi128_ps(_v)) & 0x7) == 0x7; }

VOX_INLINE bool AreAllTrue2(_SimdInt4 _v) { return (_mm_movemask_ps(_mm_castsi128_ps(_v)) & 0x3) == 0x3; }

VOX_INLINE bool AreAllTrue1(_SimdInt4 _v) { return (_mm_movemask_ps(_mm_castsi128_ps(_v)) & 0x1) == 0x1; }

VOX_INLINE bool AreAllFalse(_SimdInt4 _v) { return _mm_movemask_ps(_mm_castsi128_ps(_v)) == 0; }

VOX_INLINE bool AreAllFalse3(_SimdInt4 _v) { return (_mm_movemask_ps(_mm_castsi128_ps(_v)) & 0x7) == 0; }

VOX_INLINE bool AreAllFalse2(_SimdInt4 _v) { return (_mm_movemask_ps(_mm_castsi128_ps(_v)) & 0x3) == 0; }

VOX_INLINE bool AreAllFalse1(_SimdInt4 _v) { return (_mm_movemask_ps(_mm_castsi128_ps(_v)) & 0x1) == 0; }

VOX_INLINE SimdInt4 HAdd2(_SimdInt4 _v) {
    const __m128i hadd = _mm_add_epi32(_v, VOX_SSE_SPLAT_I(_v, 1));
    return _mm_castps_si128(_mm_move_ss(_mm_castsi128_ps(_v), _mm_castsi128_ps(hadd)));
}

VOX_INLINE SimdInt4 HAdd3(_SimdInt4 _v) {
    const __m128i hadd = _mm_add_epi32(_mm_add_epi32(_v, VOX_SSE_SPLAT_I(_v, 1)), _mm_unpackhi_epi32(_v, _v));
    return _mm_castps_si128(_mm_move_ss(_mm_castsi128_ps(_v), _mm_castsi128_ps(hadd)));
}
...
VOX_INLINE SimdInt4 HAdd4(_SimdInt4 _v) {
    ...
    return _mm_castps_si128(_mm_move_ss(v, _mm_castsi128_ps(_mm_add_epi32(haddxyzw, VOX_SSE_SPLAT_I(haddxyzw, 1)))));
}

VOX_INLINE SimdInt4 Abs(_SimdInt4 _v) {
#ifdef VOX_SIMD_SSSE3
    return _mm_abs_epi32(_v);
#else   // VOX_SIMD_SSSE3
    const __m128i zero = _mm_setzero_si128();
    return VOX_SSE_SELECT_I(_mm_cmplt_epi32(_v, zero), _mm_sub_epi32(zero, _v), _v);
#endif  // VOX_SIMD_SSSE3
}

VOX_INLINE SimdInt4 Sign(_SimdInt4 _v) { return _mm_slli_epi32(_mm_srli_epi32(_v, 31), 31); }

VOX_INLINE SimdInt4 Min(_SimdInt4 _a, _SimdInt4 _b) {
#ifdef VOX_SIMD_SSE4_1
    return _mm_min_epi32(_a, _b);
#else   // VOX_SIMD_SSE4_1
    return VOX_SSE_SELECT_I(_mm_cmplt_epi32(_a, _b), _a, _b);
#endif  // VOX_SIMD_SSE4_1
}
...
#else   // VOX_SIMD_SSE4_1
    return VOX_SSE_SELECT_I(_mm_cmpgt_epi32(_a, _b), _a, _b);
#endif  // VOX_SIMD_SSE4_1
}
...
#else   // VOX_SIMD_SSE4_1
    return VOX_SSE_SELECT_I(_mm_cmplt_epi32(zero, _v), zero, _v);
#endif  // VOX_SIMD_SSE4_1
}
...
#else   // VOX_SIMD_SSE4_1
    return VOX_SSE_SELECT_I(_mm_cmpgt_epi32(zero, _v), zero, _v);
#endif  // VOX_SIMD_SSE4_1
}
...
#else   // VOX_SIMD_SSE4_1
    const __m128i min = VOX_SSE_SELECT_I(_mm_cmplt_epi32(_v, _b), _v, _b);
    return VOX_SSE_SELECT_I(_mm_cmpgt_epi32(_a, min), _a, min);
#endif  // VOX_SIMD_SSE4_1
}

VOX_INLINE SimdInt4 Select(_SimdInt4 _b, _SimdInt4 _true, _SimdInt4 _false) {
    return VOX_SSE_SELECT_I(_b, _true, _false);
}

VOX_INLINE SimdInt4 And(_SimdInt4 _a, _SimdInt4 _b) { return _mm_and_si128(_a, _b); }

VOX_INLINE SimdInt4 AndNot(_SimdInt4 _a, _SimdInt4 _b) { return _mm_andnot_si128(_b, _a); }

VOX_INLINE SimdInt4 Or(_SimdInt4 _a, _SimdInt4 _b) { return _mm_or_si128(_a, _b); }

VOX_INLINE SimdInt4 Xor(_SimdInt4 _a, _SimdInt4 _b) { return _mm_xor_si128(_a, _b); }

VOX_INLINE SimdInt4 Not(_SimdInt4 _v) { return _mm_xor_si128(_v, _mm_cmpeq_epi32(_v, _v)); }

VOX_INLINE SimdInt4 ShiftL(_SimdInt4 _v, int _bits) { return _mm_slli_epi32(_v, _bits); }

VOX_INLINE SimdInt4 ShiftR(_SimdInt4 _v, int _bits) { return _mm_srai_epi32(_v, _bits); }

VOX_INLINE SimdInt4 ShiftRu(_SimdInt4 _v, int _bits) { return _mm_srli_epi32(_v, _bits); }

VOX_INLINE SimdInt4 CmpEq(_SimdInt4 _a, _SimdInt4 _b) { return _mm_cmpeq_epi32(_a, _b); }
...
VOX_INLINE SimdInt4 CmpLt(_SimdInt4 _a, _SimdInt4 _b) { return _mm_cmpgt_epi32(_b, _a); }
...
VOX_INLINE SimdInt4 CmpGt(_SimdInt4 _a, _SimdInt4 _b) { return _mm_cmpgt_epi32(_a, _b); }
...
VOX_INLINE Float4x4 Float4x4::identity() {
    ...
    const Float4x4 ret = {{_mm_castsi128_ps(x), _mm_castsi128_ps(_mm_slli_si128(x, 4)),
                           _mm_castsi128_ps(_mm_slli_si128(x, 8)), _mm_castsi128_ps(_mm_slli_si128(one, 12))}};
    return ret;
}
...
VOX_INLINE Float4x4 Transpose(const Float4x4& _m) {
    ...
    const Float4x4 ret = {{_mm_unpacklo_ps(tmp0, tmp1), _mm_unpackhi_ps(tmp0, tmp1), _mm_unpacklo_ps(tmp2, tmp3),
...
inline Float4x4 Invert(const Float4x4& _m, SimdInt4* _invertible) {
    ...
    tmp1 = VOX_SHUFFLE_PS1(tmp1, 0xB1);
    minor0 = _mm_mul_ps(c1, tmp1);
    minor1 = _mm_mul_ps(c0, tmp1);
    tmp1 = VOX_SHUFFLE_PS1(tmp1, 0x4E);
    minor0 = VOX_MSUB(c1, tmp1, minor0);
    minor1 = VOX_MSUB(c0, tmp1, minor1);
    minor1 = VOX_SHUFFLE_PS1(minor1, 0x4E);

    tmp1 = _mm_mul_ps(c1, c2);
    tmp1 = VOX_SHUFFLE_PS1(tmp1, 0xB1);
    minor0 = VOX_MADD(c3, tmp1, minor0);
    minor3 = _mm_mul_ps(c0, tmp1);
    tmp1 = VOX_SHUFFLE_PS1(tmp1, 0x4E);
    minor0 = VOX_NMADD(c3, tmp1, minor0);
    minor3 = VOX_MSUB(c0, tmp1, minor3);
    minor3 = VOX_SHUFFLE_PS1(minor3, 0x4E);

    tmp1 = _mm_mul_ps(VOX_SHUFFLE_PS1(c1, 0x4E), c3);
    tmp1 = VOX_SHUFFLE_PS1(tmp1, 0xB1);
    tmp2 = VOX_SHUFFLE_PS1(c2, 0x4E);
    minor0 = VOX_MADD(tmp2, tmp1, minor0);
    minor2 = _mm_mul_ps(c0, tmp1);
    tmp1 = VOX_SHUFFLE_PS1(tmp1, 0x4E);
    minor0 = VOX_NMADD(tmp2, tmp1, minor0);
    minor2 = VOX_MSUB(c0, tmp1, minor2);
    minor2 = VOX_SHUFFLE_PS1(minor2, 0x4E);

    tmp1 = _mm_mul_ps(c0, c1);
    tmp1 = VOX_SHUFFLE_PS1(tmp1, 0xB1);
    minor2 = VOX_MADD(c3, tmp1, minor2);
    minor3 = VOX_MSUB(tmp2, tmp1, minor3);
    tmp1 = VOX_SHUFFLE_PS1(tmp1, 0x4E);
    minor2 = VOX_MSUB(c3, tmp1, minor2);
    minor3 = VOX_NMADD(tmp2, tmp1, minor3);

    tmp1 = _mm_mul_ps(c0, c3);
    tmp1 = VOX_SHUFFLE_PS1(tmp1, 0xB1);
    minor1 = VOX_NMADD(tmp2, tmp1, minor1);
    minor2 = VOX_MADD(c1, tmp1, minor2);
    tmp1 = VOX_SHUFFLE_PS1(tmp1, 0x4E);
    minor1 = VOX_MADD(tmp2, tmp1, minor1);
    minor2 = VOX_NMADD(c1, tmp1, minor2);

    tmp1 = _mm_mul_ps(c0, tmp2);
    tmp1 = VOX_SHUFFLE_PS1(tmp1, 0xB1);
    minor1 = VOX_MADD(c3, tmp1, minor1);
    minor3 = VOX_NMADD(c1, tmp1, minor3);
    tmp1 = VOX_SHUFFLE_PS1(tmp1, 0x4E);
    minor1 = VOX_NMADD(c3, tmp1, minor1);
    minor3 = VOX_MADD(c1, tmp1, minor3);

    __m128 det;
    det = _mm_mul_ps(c0, minor0);
    det = _mm_add_ps(VOX_SHUFFLE_PS1(det, 0x4E), det);
    det = _mm_add_ss(VOX_SHUFFLE_PS1(det, 0xB1), det);
    ...
    tmp1 = VOX_SSE_SELECT_F(invertible, RcpEstNR(det), simd_float4::zero());
    det = VOX_NMADDX(det, _mm_mul_ss(tmp1, tmp1), _mm_add_ss(tmp1, tmp1));
    det = VOX_SHUFFLE_PS1(det, 0x00);

    // Copy the final columns
    const Float4x4 ret = {
            {_mm_mul_ps(det, minor0), _mm_mul_ps(det, minor1), _mm_mul_ps(det, minor2), _mm_mul_ps(det, minor3)}};
    return ret;
}
...
Float4x4 Float4x4::Translation(_SimdFloat4 _v) {
    ...
    const Float4x4 ret = {{_mm_castsi128_ps(x), _mm_castsi128_ps(_mm_slli_si128(x, 4)),
                           ...
                           VOX_SSE_SELECT_F(mask000f, _mm_castsi128_ps(one), _v)}};
    return ret;
}  // math
...
Float4x4 Float4x4::Scaling(_SimdFloat4 _v) {
    ...
    const Float4x4 ret = {
            {_mm_and_ps(_v, _mm_castsi128_ps(if000)), _mm_and_ps(_v, _mm_castsi128_ps(_mm_slli_si128(if000, 4))),
             _mm_and_ps(_v, _mm_castsi128_ps(_mm_slli_si128(if000, 8))), _mm_castsi128_ps(_mm_slli_si128(ione, 12))}};
    return ret;
}  // math

VOX_INLINE Float4x4 Translate(const Float4x4& _m, _SimdFloat4 _v) {
    const __m128 a01 = VOX_MADD(_m.cols[0], VOX_SSE_SPLAT_F(_v, 0), _mm_mul_ps(_m.cols[1], VOX_SSE_SPLAT_F(_v, 1)));
    const __m128 m3 = VOX_MADD(_m.cols[2], VOX_SSE_SPLAT_F(_v, 2), _m.cols[3]);
    const Float4x4 ret = {{_m.cols[0], _m.cols[1], _m.cols[2], _mm_add_ps(a01, m3)}};
    return ret;
}

VOX_INLINE Float4x4 Scale(const Float4x4& _m, _SimdFloat4 _v) {
    const Float4x4 ret = {{_mm_mul_ps(_m.cols[0], VOX_SSE_SPLAT_F(_v, 0)),
                           _mm_mul_ps(_m.cols[1], VOX_SSE_SPLAT_F(_v, 1)),
                           _mm_mul_ps(_m.cols[2], VOX_SSE_SPLAT_F(_v, 2)), _m.cols[3]}};
    return ret;
}

VOX_INLINE Float4x4 ColumnMultiply(const Float4x4& _m, _SimdFloat4 _v) {
    const Float4x4 ret = {{_mm_mul_ps(_m.cols[0], _v), _mm_mul_ps(_m.cols[1], _v), _mm_mul_ps(_m.cols[2], _v),
...
inline SimdInt4 IsNormalized(const Float4x4& _m) {
    ...
    const __m128 dot = VOX_MADD(row0, row0, VOX_MADD(row1, row1, _mm_mul_ps(row2, row2)));
    const __m128 normalized = _mm_and_ps(_mm_cmplt_ps(dot, max), _mm_cmpgt_ps(dot, min));
    return _mm_castps_si128(_mm_and_ps(normalized, _mm_castsi128_ps(simd_int4::mask_fff0())));
}
...
inline SimdFloat4 ToQuaternion(const Float4x4& _m) {
    ...
    const __m128 xx_yy = VOX_SSE_SELECT_F(mask_0f00, _m.cols[1], _m.cols[0]);
    const __m128 xx_yy_0010 = VOX_SHUFFLE_PS1(xx_yy, _MM_SHUFFLE(0, 0, 1, 0));
    const __m128 xx_yy_zz_xx = VOX_SSE_SELECT_F(mask_00f0, _m.cols[2], xx_yy_0010);
    const __m128 yy_zz_xx_yy = VOX_SHUFFLE_PS1(xx_yy_zz_xx, _MM_SHUFFLE(1, 0, 2, 1));
    const __m128 zz_xx_yy_zz = VOX_SHUFFLE_PS1(xx_yy_zz_xx, _MM_SHUFFLE(2, 1, 0, 2));
    ...
    const __m128 radicand = _mm_add_ps(VOX_SSE_SELECT_F(mask_000f, diag_sum, diag_diff), one);
    const __m128 invSqrt = one / _mm_sqrt_ps(radicand);

    __m128 zy_xz_yx = VOX_SSE_SELECT_F(mask_00f0, _m.cols[1], _m.cols[0]);
    zy_xz_yx = VOX_SHUFFLE_PS1(zy_xz_yx, _MM_SHUFFLE(0, 1, 2, 2));
    zy_xz_yx = VOX_SSE_SELECT_F(mask_0f00, VOX_SSE_SPLAT_F(_m.cols[2], 0), zy_xz_yx);
    __m128 yz_zx_xy = VOX_SSE_SELECT_F(mask_f000, _m.cols[1], _m.cols[0]);
    yz_zx_xy = VOX_SHUFFLE_PS1(yz_zx_xy, _MM_SHUFFLE(0, 0, 2, 0));
    yz_zx_xy = VOX_SSE_SELECT_F(mask_f000, VOX_SSE_SPLAT_F(_m.cols[2], 1), yz_zx_xy);
    ...
    const __m128 sum0 = VOX_SHUFFLE_PS1(sum, _MM_SHUFFLE(0, 1, 2, 0));
    const __m128 sum1 = VOX_SHUFFLE_PS1(sum, _MM_SHUFFLE(0, 0, 0, 2));
    const __m128 sum2 = VOX_SHUFFLE_PS1(sum, _MM_SHUFFLE(0, 0, 0, 1));
    __m128 res0 = VOX_SSE_SELECT_F(mask_000f, VOX_SSE_SPLAT_F(diff, 0), sum0);
    __m128 res1 = VOX_SSE_SELECT_F(mask_000f, VOX_SSE_SPLAT_F(diff, 1), sum1);
    __m128 res2 = VOX_SSE_SELECT_F(mask_000f, VOX_SSE_SPLAT_F(diff, 2), sum2);
    res0 = _mm_mul_ps(VOX_SSE_SELECT_F(mask_f000, radicand, res0), VOX_SSE_SPLAT_F(scale, 0));
    res1 = _mm_mul_ps(VOX_SSE_SELECT_F(mask_0f00, radicand, res1), VOX_SSE_SPLAT_F(scale, 1));
    res2 = _mm_mul_ps(VOX_SSE_SELECT_F(mask_00f0, radicand, res2), VOX_SSE_SPLAT_F(scale, 2));
    __m128 res3 = _mm_mul_ps(VOX_SSE_SELECT_F(mask_000f, radicand, diff), VOX_SSE_SPLAT_F(scale, 3));

    const __m128 xx = VOX_SSE_SPLAT_F(_m.cols[0], 0);
    const __m128 yy = VOX_SSE_SPLAT_F(_m.cols[1], 1);
    const __m128 zz = VOX_SSE_SPLAT_F(_m.cols[2], 2);
    ...
    const __m128i cond2 = _mm_castps_si128(_mm_cmpgt_ps(VOX_SSE_SPLAT_F(diag_sum, 0), _mm_castsi128_ps(zero)));
    __m128 res = VOX_SSE_SELECT_F(cond0, res1, res0);
    res = VOX_SSE_SELECT_F(cond1, res2, res);
    res = VOX_SSE_SELECT_F(cond2, res3, res);

    assert(AreAllTrue1(IsNormalizedEst4(res)));
    return res;
}

inline bool ToAffine(const Float4x4& _m, SimdFloat4* _translation, SimdFloat4* _quaternion, SimdFloat4* _scale) {
    const __m128 zero = _mm_setzero_ps();
    ...
    *_translation = VOX_SSE_SELECT_F(fff0, _m.cols[3], one);
    ...
    const __m128 dot = VOX_MADD(m_row0, m_row0, VOX_MADD(m_row1, m_row1, _mm_mul_ps(m_row2, m_row2)));
    ...
    if (mask & 1) {
        ...
        orthonormal.cols[1] = _mm_div_ps(_m.cols[1], VOX_SSE_SPLAT_F(abs_scale, 1));
        orthonormal.cols[0] = Normalize3(Cross3(orthonormal.cols[1], _m.cols[2]));
        orthonormal.cols[2] = Normalize3(Cross3(orthonormal.cols[0], orthonormal.cols[1]));
    } else if (mask & 4) {
        if (mask & 3) {
            return false;
        }
        orthonormal.cols[0] = _mm_div_ps(_m.cols[0], VOX_SSE_SPLAT_F(abs_scale, 0));
        orthonormal.cols[2] = Normalize3(Cross3(orthonormal.cols[0], _m.cols[1]));
        orthonormal.cols[1] = Normalize3(Cross3(orthonormal.cols[2], orthonormal.cols[0]));
    } else {  // Favor z axis in the default case
        if (mask & 5) {
            return false;
        }
        orthonormal.cols[2] = _mm_div_ps(_m.cols[2], VOX_SSE_SPLAT_F(abs_scale, 2));
        orthonormal.cols[1] = Normalize3(Cross3(orthonormal.cols[2], _m.cols[0]));
        orthonormal.cols[0] = Normalize3(Cross3(orthonormal.cols[1], orthonormal.cols[2]));
    }
    ...
    const __m128 scale_dot = VOX_MADD(o_row0, m_row0, VOX_MADD(o_row1, m_row1, _mm_mul_ps(o_row2, m_row2)));

    const __m128i cond = _mm_castps_si128(_mm_cmpgt_ps(scale_dot, zero));
    const __m128 cfalse = _mm_sub_ps(zero, abs_scale);
    const __m128 scale = VOX_SSE_SELECT_F(cond, abs_scale, cfalse);
    *_scale = VOX_SSE_SELECT_F(fff0, scale, one);
...
inline Float4x4 Float4x4::FromAxisAngle(_SimdFloat4 _axis, _SimdFloat4 _angle) {
    ...
    const __m128 v0 = _mm_mul_ps(_mm_mul_ps(one_minus_cos, VOX_SHUFFLE_PS1(_axis, _MM_SHUFFLE(3, 0, 2, 1))),
                                 VOX_SHUFFLE_PS1(_axis, _MM_SHUFFLE(3, 1, 0, 2)));
    ...
    const __m128 v1 = VOX_SHUFFLE_PS1(r1r22120, _MM_SHUFFLE(0, 3, 2, 1));
    const __m128 r1r20011 = _mm_shuffle_ps(r1, r2, _MM_SHUFFLE(0, 0, 1, 1));
    const __m128 v2 = VOX_SHUFFLE_PS1(r1r20011, _MM_SHUFFLE(2, 0, 2, 0));

    const __m128 t0 = _mm_shuffle_ps(r0fff0, v1, _MM_SHUFFLE(1, 0, 3, 0));
    const __m128 t1 = _mm_shuffle_ps(r0fff0, v1, _MM_SHUFFLE(3, 2, 3, 1));
    const Float4x4 ret = {{VOX_SHUFFLE_PS1(t0, _MM_SHUFFLE(1, 3, 2, 0)), VOX_SHUFFLE_PS1(t1, _MM_SHUFFLE(1, 3, 0, 2)),
                           _mm_shuffle_ps(v2, r0fff0, _MM_SHUFFLE(3, 2, 1, 0)), w_axis}};
    return ret;
}
...
inline Float4x4 Float4x4::FromQuaternion(_SimdFloat4 _quaternion) {
    ...
    const __m128 r0 = _mm_sub_ps(_mm_sub_ps(c1110, _mm_and_ps(VOX_SHUFFLE_PS1(vms, _MM_SHUFFLE(3, 0, 0, 1)), fff0)),
                                 _mm_and_ps(VOX_SHUFFLE_PS1(vms, _MM_SHUFFLE(3, 1, 2, 2)), fff0));
    const __m128 v0 = _mm_mul_ps(VOX_SHUFFLE_PS1(_quaternion, _MM_SHUFFLE(3, 1, 0, 0)),
                                 VOX_SHUFFLE_PS1(vsum, _MM_SHUFFLE(3, 2, 1, 2)));
    const __m128 v1 = _mm_mul_ps(VOX_SHUFFLE_PS1(_quaternion, _MM_SHUFFLE(3, 3, 3, 3)),
                                 VOX_SHUFFLE_PS1(vsum, _MM_SHUFFLE(3, 0, 2, 1)));
    ...
    const __m128 v2 = VOX_SHUFFLE_PS1(r1r21021, _MM_SHUFFLE(1, 3, 2, 0));
    const __m128 r1r22200 = _mm_shuffle_ps(r1, r2, _MM_SHUFFLE(2, 2, 0, 0));
    const __m128 v3 = VOX_SHUFFLE_PS1(r1r22200, _MM_SHUFFLE(2, 0, 2, 0));

    const __m128 q0 = _mm_shuffle_ps(r0, v2, _MM_SHUFFLE(1, 0, 3, 0));
    const __m128 q1 = _mm_shuffle_ps(r0, v2, _MM_SHUFFLE(3, 2, 3, 1));
    const Float4x4 ret = {{VOX_SHUFFLE_PS1(q0, _MM_SHUFFLE(1, 3, 2, 0)), VOX_SHUFFLE_PS1(q1, _MM_SHUFFLE(1, 3, 0, 2)),
                           _mm_shuffle_ps(v3, r0, _MM_SHUFFLE(3, 2, 1, 0)), w_axis}};
    return ret;
}

inline Float4x4 Float4x4::FromAffine(_SimdFloat4 _translation, _SimdFloat4 _quaternion, _SimdFloat4 _scale) {
    assert(AreAllTrue1(IsNormalizedEst4(_quaternion)));
    ...
    const Float4x4 ret = {{_mm_mul_ps(VOX_SHUFFLE_PS1(q0, _MM_SHUFFLE(1, 3, 2, 0)), VOX_SSE_SPLAT_F(_scale, 0)),
                           _mm_mul_ps(VOX_SHUFFLE_PS1(q1, _MM_SHUFFLE(1, 3, 0, 2)), VOX_SSE_SPLAT_F(_scale, 1)),
                           _mm_mul_ps(_mm_shuffle_ps(v3, r0, _MM_SHUFFLE(3, 2, 1, 0)), VOX_SSE_SPLAT_F(_scale, 2)),
...
VOX_INLINE vox::simd_math::SimdFloat4 operator*(const vox::simd_math::Float4x4& _m, vox::simd_math::_SimdFloat4 _v) {
    ...
    const __m128 a01 = VOX_MADD(VOX_SSE_SPLAT_F(_v, 1), _m.cols[1], xxxx);
    const __m128 a23 = VOX_MADD(VOX_SSE_SPLAT_F(_v, 3), _m.cols[3], zzzz);
    return _mm_add_ps(a01, a23);
}
...
inline vox::simd_math::Float4x4 operator*(const vox::simd_math::Float4x4& _a, const vox::simd_math::Float4x4& _b) {
    vox::simd_math::Float4x4 ret;
    {
        ...
        const __m128 a01 = VOX_MADD(VOX_SSE_SPLAT_F(_b.cols[0], 1), _a.cols[1], xxxx);
        const __m128 a23 = VOX_MADD(VOX_SSE_SPLAT_F(_b.cols[0], 3), _a.cols[3], zzzz);
        ret.cols[0] = _mm_add_ps(a01, a23);
    }
    {
        const __m128 xxxx = _mm_mul_ps(VOX_SSE_SPLAT_F(_b.cols[1], 0), _a.cols[0]);
        const __m128 zzzz = _mm_mul_ps(VOX_SSE_SPLAT_F(_b.cols[1], 2), _a.cols[2]);
        const __m128 a01 = VOX_MADD(VOX_SSE_SPLAT_F(_b.cols[1], 1), _a.cols[1], xxxx);
        const __m128 a23 = VOX_MADD(VOX_SSE_SPLAT_F(_b.cols[1], 3), _a.cols[3], zzzz);
        ret.cols[1] = _mm_add_ps(a01, a23);
    }
    {
        const __m128 xxxx = _mm_mul_ps(VOX_SSE_SPLAT_F(_b.cols[2], 0), _a.cols[0]);
        const __m128 zzzz = _mm_mul_ps(VOX_SSE_SPLAT_F(_b.cols[2], 2), _a.cols[2]);
        const __m128 a01 = VOX_MADD(VOX_SSE_SPLAT_F(_b.cols[2], 1), _a.cols[1], xxxx);
        const __m128 a23 = VOX_MADD(VOX_SSE_SPLAT_F(_b.cols[2], 3), _a.cols[3], zzzz);
        ret.cols[2] = _mm_add_ps(a01, a23);
    }
    {
        const __m128 xxxx = _mm_mul_ps(VOX_SSE_SPLAT_F(_b.cols[3], 0), _a.cols[0]);
        const __m128 zzzz = _mm_mul_ps(VOX_SSE_SPLAT_F(_b.cols[3], 2), _a.cols[2]);
        const __m128 a01 = VOX_MADD(VOX_SSE_SPLAT_F(_b.cols[3], 1), _a.cols[1], xxxx);
        const __m128 a23 = VOX_MADD(VOX_SSE_SPLAT_F(_b.cols[3], 3), _a.cols[3], zzzz);
...
VOX_INLINE float HalfToFloat(uint16_t _h) { return _mm_cvtss_f32(HalfToFloat(_mm_set1_epi32(_h))); }
...
inline SimdInt4 FloatToHalf(_SimdFloat4 _f) {
    ...
    const __m128i inf_or_nan = _mm_or_si128(_mm_and_si128(b_isnan, nanbit), infty_as_fp16);
...
#undef VOX_SSE_SPLAT_F
#undef VOX_SSE_HADD2_F
#undef VOX_SSE_HADD3_F
#undef VOX_SSE_HADD4_F
#undef VOX_SSE_DOT2_F
#undef VOX_SSE_DOT3_F
#undef VOX_SSE_DOT4_F
#undef VOX_MADD
#undef VOX_MSUB
#undef VOX_NMADD
#undef VOX_NMSUB
...
#undef VOX_NMADDX
#undef VOX_NMSUBX
#undef VOX_SSE_SELECT_F
#undef VOX_SSE_SPLAT_I
#undef VOX_SSE_SELECT_I