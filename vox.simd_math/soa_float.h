...
VOX_INLINE vox::simd_math::SoaFloat4 operator+(const vox::simd_math::SoaFloat4& _a, const vox::simd_math::SoaFloat4& _b) {
    const vox::simd_math::SoaFloat4 r = {_a.x + _b.x, _a.y + _b.y, _a.z + _b.z, _a.w + _b.w};
    return r;
}
VOX_INLINE vox::simd_math::SoaFloat3 operator+(const vox::simd_math::SoaFloat3& _a, const vox::simd_math::SoaFloat3& _b) {
    const vox::simd_math::SoaFloat3 r = {_a.x + _b.x, _a.y + _b.y, _a.z + _b.z};
    return r;
}
VOX_INLINE vox::simd_math::SoaFloat2 operator+(const vox::simd_math::SoaFloat2& _a, const vox::simd_math::SoaFloat2& _b) {
    const vox::simd_math::SoaFloat2 r = {_a.x + _b.x, _a.y + _b.y};
    return r;
}
...
VOX_INLINE vox::simd_math::SoaFloat4 operator-(const vox::simd_math::SoaFloat4& _v) {
    const vox::simd_math::SoaFloat4 r = {-_v.x, -_v.y, -_v.z, -_v.w};
    return r;
}
VOX_INLINE vox::simd_math::SoaFloat3 operator-(const vox::simd_math::SoaFloat3& _v) {
    const vox::simd_math::SoaFloat3 r = {-_v.x, -_v.y, -_v.z};
    return r;
}
VOX_INLINE vox::simd_math::SoaFloat2 operator-(const vox::simd_math::SoaFloat2& _v) {
    const vox::simd_math::SoaFloat2 r = {-_v.x, -_v.y};
    return r;
}
...
// operator *.
VOX_INLINE vox::simd_math::SoaFloat4 operator*(const vox::simd_math::SoaFloat4& _a, vox::simd_math::_SimdFloat4 _f) {
    const vox::simd_math::SoaFloat4 r = {_a.x * _f, _a.y * _f, _a.z * _f, _a.w * _f};
    return r;
}
VOX_INLINE vox::simd_math::SoaFloat3 operator*(const vox::simd_math::SoaFloat3& _a, vox::simd_math::_SimdFloat4 _f) {
    const vox::simd_math::SoaFloat3 r = {_a.x * _f, _a.y * _f, _a.z * _f};
    return r;
}
VOX_INLINE vox::simd_math::SoaFloat2 operator*(const vox::simd_math::SoaFloat2& _a, vox::simd_math::_SimdFloat4 _f) {
    const vox::simd_math::SoaFloat2 r = {_a.x * _f, _a.y * _f};
    return r;
}

// Multiplies _a and _b, then adds _addend.
// v = (_a * _b) + _addend
VOX_INLINE vox::simd_math::SoaFloat2 MAdd(const vox::simd_math::SoaFloat2& _a,
                                     const vox::simd_math::SoaFloat2& _b,
                                     const vox::simd_math::SoaFloat2& _addend) {
    const vox::simd_math::SoaFloat2 r = {vox::simd_math::MAdd(_a.x, _b.x, _addend.x), vox::simd_math::MAdd(_a.y, _b.y, _addend.y)};
    return r;
}
VOX_INLINE vox::simd_math::SoaFloat3 MAdd(const vox::simd_math::SoaFloat3& _a,
                                     const vox::simd_math::SoaFloat3& _b,
                                     const vox::simd_math::SoaFloat3& _addend) {
    const vox::simd_math::SoaFloat3 r = {vox::simd_math::MAdd(_a.x, _b.x, _addend.x), vox::simd_math::MAdd(_a.y, _b.y, _addend.y),
                                    vox::simd_math::MAdd(_a.z, _b.z, _addend.z)};
    return r;
}
VOX_INLINE vox::simd_math::SoaFloat4 MAdd(const vox::simd_math::SoaFloat4& _a,
                                     const vox::simd_math::SoaFloat4& _b,
                                     const vox::simd_math::SoaFloat4& _addend) {
    const vox::simd_math::SoaFloat4 r = {vox::simd_math::MAdd(_a.x, _b.x, _addend.x), vox::simd_math::MAdd(_a.y, _b.y, _addend.y),
                                    vox::simd_math::MAdd(_a.z, _b.z, _addend.z), vox::simd_math::MAdd(_a.w, _b.w, _addend.w)};
    return r;
}
...
VOX_INLINE vox::simd_math::SimdInt4 operator<(const vox::simd_math::SoaFloat4& _a, const vox::simd_math::SoaFloat4& _b) {
    const vox::simd_math::SimdInt4 x = vox::simd_math::CmpLt(_a.x, _b.x);
    const vox::simd_math::SimdInt4 y = vox::simd_math::CmpLt(_a.y, _b.y);
    const vox::simd_math::SimdInt4 z = vox::simd_math::CmpLt(_a.z, _b.z);
    const vox::simd_math::SimdInt4 w = vox::simd_math::CmpLt(_a.w, _b.w);
    return vox::simd_math::And(vox::simd_math::And(vox::simd_math::And(x, y), z), w);
}
VOX_INLINE vox::simd_math::SimdInt4 operator<(const vox::simd_math::SoaFloat3& _a, const vox::simd_math::SoaFloat3& _b) {
    const vox::simd_math::SimdInt4 x = vox::simd_math::CmpLt(_a.x, _b.x);
    const vox::simd_math::SimdInt4 y = vox::simd_math::CmpLt(_a.y, _b.y);
    const vox::simd_math::SimdInt4 z = vox::simd_math::CmpLt(_a.z, _b.z);
    return vox::simd_math::And(vox::simd_math::And(x, y), z);
}
VOX_INLINE vox::simd_math::SimdInt4 operator<(const vox::simd_math::SoaFloat2& _a, const vox::simd_math::SoaFloat2& _b) {
    const vox::simd_math::SimdInt4 x = vox::simd_math::CmpLt(_a.x, _b.x);
    const vox::simd_math::SimdInt4 y = vox::simd_math::CmpLt(_a.y, _b.y);
    return vox::simd_math::And(x, y);
}

// Returns true if each element of an is less or equal to each element of _b.
VOX_INLINE vox::simd_math::SimdInt4 operator<=(const vox::simd_math::SoaFloat4& _a, const vox::simd_math::SoaFloat4& _b) {
    const vox::simd_math::SimdInt4 x = vox::simd_math::CmpLe(_a.x, _b.x);
    const vox::simd_math::SimdInt4 y = vox::simd_math::CmpLe(_a.y, _b.y);
    const vox::simd_math::SimdInt4 z = vox::simd_math::CmpLe(_a.z, _b.z);
    const vox::simd_math::SimdInt4 w = vox::simd_math::CmpLe(_a.w, _b.w);
    return vox::simd_math::And(vox::simd_math::And(vox::simd_math::And(x, y), z), w);
}
VOX_INLINE vox::simd_math::SimdInt4 operator<=(const vox::simd_math::SoaFloat3& _a, const vox::simd_math::SoaFloat3& _b) {
    const vox::simd_math::SimdInt4 x = vox::simd_math::CmpLe(_a.x, _b.x);
...
VOX_INLINE vox::simd_math::SimdInt4 operator>(const vox::simd_math::SoaFloat4& _a, const vox::simd_math::SoaFloat4& _b) {
    const vox::simd_math::SimdInt4 x = vox::simd_math::CmpGt(_a.x, _b.x);
    const vox::simd_math::SimdInt4 y = vox::simd_math::CmpGt(_a.y, _b.y);
    const vox::simd_math::SimdInt4 z = vox::simd_math::CmpGt(_a.z, _b.z);
    const vox::simd_math::SimdInt4 w = vox::simd_math::CmpGt(_a.w, _b.w);
    return vox::simd_math::And(vox::simd_math::And(vox::simd_math::And(x, y), z), w);
}
VOX_INLINE vox::simd_math::SimdInt4 operator>(const vox::simd_math::SoaFloat3& _a, const vox::simd_math::SoaFloat3& _b) {
    const vox::simd_math::SimdInt4 x = vox::simd_math::CmpGt(_a.x, _b.x);
...
VOX_INLINE vox::simd_math::SimdInt4 operator>=(const vox::simd_math::SoaFloat4& _a, const vox::simd_math::SoaFloat4& _b) {
    const vox::simd_math::SimdInt4 x = vox::simd_math::CmpGe(_a.x, _b.x);
    const vox::simd_math::SimdInt4 y = vox::simd_math::CmpGe(_a.y, _b.y);
    const vox::simd_math::SimdInt4 z = vox::simd_math::CmpGe(_a.z, _b.z);
    const vox::simd_math::SimdInt4 w = vox::simd_math::CmpGe(_a.w, _b.w);
    return vox::simd_math::And(vox::simd_math::And(vox::simd_math::And(x, y), z), w);
}
VOX_INLINE vox::simd_math::SimdInt4 operator>=(const vox::simd_math::SoaFloat3& _a, const vox::simd_math::SoaFloat3& _b) {
    const vox::simd_math::SimdInt4 x = vox::simd_math::CmpGe(_a.x, _b.x);
...
// Uses a bitwise comparison of _a and _b, no tolerance is applied.
VOX_INLINE vox::simd_math::SimdInt4 operator!=(const vox::simd_math::SoaFloat4& _a, const vox::simd_math::SoaFloat4& _b) {
    const vox::simd_math::SimdInt4 x = vox::simd_math::CmpNe(_a.x, _b.x);
    const vox::simd_math::SimdInt4 y = vox::simd_math::CmpNe(_a.y, _b.y);
    const vox::simd_math::SimdInt4 z = vox::simd_math::CmpNe(_a.z, _b.z);
    const vox::simd_math::SimdInt4 w = vox::simd_math::CmpNe(_a.w, _b.w);
    return vox::simd_math::Or(vox::simd_math::Or(vox::simd_math::Or(x, y), z), w);
}
VOX_INLINE vox::simd_math::SimdInt4 operator!=(const vox::simd_math::SoaFloat3& _a, const vox::simd_math::SoaFloat3& _b) {
    const vox::simd_math::SimdInt4 x = vox::simd_math::CmpNe(_a.x, _b.x);
    const vox::simd_math::SimdInt4 y = vox::simd_math::CmpNe(_a.y, _b.y);
    const vox::simd_math::SimdInt4 z = vox::simd_math::CmpNe(_a.z, _b.z);
    return vox::simd_math::Or(vox::simd_math::Or(x, y), z);
}
VOX_INLINE vox::simd_math::SimdInt4 operator!=(const vox::simd_math::SoaFloat2& _a, const vox::simd_math::SoaFloat2& _b) {
    const vox::simd_math::SimdInt4 x = vox::simd_math::CmpNe(_a.x, _b.x);
    const vox::simd_math::SimdInt4 y = vox::simd_math::CmpNe(_a.y, _b.y);
    return vox::simd_math::Or(x, y);
}
...
VOX_INLINE simd_math::SimdInt4 IsNormalized(const SoaFloat4& _v) {
    const SimdFloat4 len2 = _v.x * _v.x + _v.y * _v.y + _v.z * _v.z + _v.w * _v.w;
    return CmpLt(Abs(len2 - simd_math::simd_float4::one()), simd_float4::Load1(kNormalizationToleranceSq));
}
VOX_INLINE simd_math::SimdInt4 IsNormalized(const SoaFloat3& _v) {
    const SimdFloat4 len2 = _v.x * _v.x + _v.y * _v.y + _v.z * _v.z;
    return CmpLt(Abs(len2 - simd_math::simd_float4::one()), simd_float4::Load1(kNormalizationToleranceSq));
}
VOX_INLINE simd_math::SimdInt4 IsNormalized(const SoaFloat2& _v) {
    const SimdFloat4 len2 = _v.x * _v.x + _v.y * _v.y;
    return CmpLt(Abs(len2 - simd_math::simd_float4::one()), simd_float4::Load1(kNormalizationToleranceSq));
}

// Test if each vector _v is normalized using estimated tolerance.
VOX_INLINE simd_math::SimdInt4 IsNormalizedEst(const SoaFloat4& _v) {
    const SimdFloat4 len2 = _v.x * _v.x + _v.y * _v.y + _v.z * _v.z + _v.w * _v.w;
    return CmpLt(Abs(len2 - simd_math::simd_float4::one()), simd_float4::Load1(kNormalizationToleranceEstSq));
}
VOX_INLINE simd_math::SimdInt4 IsNormalizedEst(const SoaFloat3& _v) {
    const SimdFloat4 len2 = _v.x * _v.x + _v.y * _v.y + _v.z * _v.z;
    return CmpLt(Abs(len2 - simd_math::simd_float4::one()), simd_float4::Load1(kNormalizationToleranceEstSq));
}
VOX_INLINE simd_math::SimdInt4 IsNormalizedEst(const SoaFloat2& _v) {
    const SimdFloat4 len2 = _v.x * _v.x + _v.y * _v.y;
    return CmpLt(Abs(len2 - simd_math::simd_float4::one()), simd_float4::Load1(kNormalizationToleranceEstSq));
}
...
VOX_INLINE SoaFloat4 NormalizeSafe(const SoaFloat4& _v, const SoaFloat4& _safer) {
    ...
    const SimdFloat4 len2 = _v.x * _v.x + _v.y * _v.y + _v.z * _v.z + _v.w * _v.w;
    const simd_math::SimdInt4 b = CmpNe(len2, simd_math::simd_float4::zero());
    const SimdFloat4 inv_len = simd_math::simd_float4::one() / Sqrt(len2);
