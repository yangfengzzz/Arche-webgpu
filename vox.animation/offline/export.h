...
#ifdef VOX_BUILD_ANIMOFFLINE_LIB
// Import/Export for dynamic linking while building vox
#define VOX_ANIMOFFLINE_DLL __declspec(dllexport)
#else
#define VOX_ANIMOFFLINE_DLL __declspec(dllimport)
#endif
#else  // defined(_MSC_VER) && defined(VOX_USE_DYNAMIC_LINKING)
// Static or non msvc linking
#define VOX_ANIMOFFLINE_DLL
