...
//
// Parsing is invoked through vox::options::ParseCommandLine function, providing
...
//
// To declare/register a new option, use VOX_OPTIONS_DECLARE_* like macros.
// Supported options types are bool, int, float and string (c string).
// VOX_OPTIONS_DECLARE_* macros arguments allow to give the option a:
...
// VOX_OPTIONS_DECLARE_BOOL(verbose, "Display verbose output", false, false);
...
// _argv) arguments. Options are registered using VOX_OPTIONS_DECLARE_* macros.
...
VOX_ASSET_DLL ParseResult ParseCommandLine(int _argc,
...
VOX_ASSET_DLL vox::string ParsedExecutablePath();
...
// returns a default empty string.
VOX_ASSET_DLL const char* ParsedExecutableName();
...
// returns a default empty string.
VOX_ASSET_DLL const char* ParsedExecutableUsage();

#define VOX_OPTIONS_DECLARE_BOOL(_name, _help, _default, _required) \
    VOX_OPTIONS_DECLARE_VARIABLE(vox::options::BoolOption, _name, _help, _default, _required)
#define VOX_OPTIONS_DECLARE_BOOL_FN(_name, _help, _default, _required, _fn) \
    VOX_OPTIONS_DECLARE_VARIABLE_FN(vox::options::BoolOption, _name, _help, _default, _required, _fn)

#define VOX_OPTIONS_DECLARE_INT(_name, _help, _default, _required) \
    VOX_OPTIONS_DECLARE_VARIABLE(vox::options::IntOption, _name, _help, _default, _required)
#define VOX_OPTIONS_DECLARE_INT_FN(_name, _help, _default, _required, _fn) \
    VOX_OPTIONS_DECLARE_VARIABLE_FN(vox::options::IntOption, _name, _help, _default, _required, _fn)

#define VOX_OPTIONS_DECLARE_FLOAT(_name, _help, _default, _required) \
    VOX_OPTIONS_DECLARE_VARIABLE(vox::options::FloatOption, _name, _help, _default, _required)
#define VOX_OPTIONS_DECLARE_FLOAT_FN(_name, _help, _default, _required, _fn) \
    VOX_OPTIONS_DECLARE_VARIABLE_FN(vox::options::FloatOption, _name, _help, _default, _required, _fn)

#define VOX_OPTIONS_DECLARE_STRING(_name, _help, _default, _required) \
    VOX_OPTIONS_DECLARE_VARIABLE(vox::options::StringOption, _name, _help, _default, _required)
#define VOX_OPTIONS_DECLARE_STRING_FN(_name, _help, _default, _required, _fn) \
    VOX_OPTIONS_DECLARE_VARIABLE_FN(vox::options::StringOption, _name, _help, _default, _required, _fn)

#define VOX_OPTIONS_DECLARE_VARIABLE(_type, _name, _help, _default, _required) \
    /* Instantiates a registrer for an option of type _type with name _name */ \
    static vox::options::internal::Registrer<_type> OPTIONS_##_name(#_name, _help, _default, _required);
#define VOX_OPTIONS_DECLARE_VARIABLE_FN(_type, _name, _help, _default, _required, _fn) \
    /* Instantiates a registrer for an option of type _type with name _name */         \
    static vox::options::internal::Registrer<_type> OPTIONS_##_name(#_name, _help, _default, _required, _fn);

// Defines option interface.
class VOX_ASSET_DLL Option {
public:
    ...
    [[nodiscard]] bool statisfied() const { return parsed_ || !required_; }
    ...
    [[nodiscard]] virtual vox::string FormatDefault() const = 0;

    // Outputs type of value as a c string.
    [[nodiscard]] virtual const char* FormatType() const = 0;
...
protected:
    ...
    Option(const char* _name, const char* _help, bool _required, ValidateFn _validate = nullptr);
...
private:
    // Parse the command line and set the option value.
    bool ParseImpl(const char* _argv) override;

    // Restores default value implementation.
    void RestoreDefaultImpl() override { value_ = default_; }

    // Outputs default value as a string.
    [[nodiscard]] vox::string FormatDefault() const override;
...
public:
    ...
    [[nodiscard]] int max_options() const;
    ...
    [[nodiscard]] const char* usage() const;
    ...
    [[nodiscard]] vox::string executable_path() const;

    // Returns the name of the executable that was extracted from argument 0.
    [[nodiscard]] const char* executable_name() const;
