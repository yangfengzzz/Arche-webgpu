...
public:
     ...
     */
    Entity* createEmptyEntity(bool p_focusOnCreation = true,
     ...
     * by the given path
     */
    Entity* createEntityWithModel(const std::string& p_path,
...
public:
     ...
     */
    void propagateFileRenameThroughSavedFilesOfType(const std::string& p_previousName,
